...
static void
print_symb (int symb, int i, int j)
{
    if (symb < 0)
    {
...
static void
print_prod (int i, int k, ushort *prod_core)
{
...
static int
ARN_keval (int Aij, int i, int j, int *rhs_stack)
{
...
static void
ksem_td_mark (int Aij, int i, int j, int x)
{
...
static void
mrr_generate (int i, int h, int j, int item)
{
...
static void
mutual_right_recursive (int j, int init_prod_order, int *out_prod_order)
{
...
static void
sem_td_mark (int Aij, int i, int j)
{
