...
extern BOOLEAN			X_root_write (/* X_root_header *header_ptr;
					       int file; */);
/* Write on "file" the structure "*header_ptr" */

extern BOOLEAN			X_root_read (/* X_root_header *header_ptr;
						int file; */);
...
extern void			X_root_array_to_c (/* X_root_header *header_ptr;
						      FILE *F_X;
						      char *name; */);

/* Print on "F_X" the C text for the "arrays" of "header_ptr" */

extern void			X_root_header_to_c (/* X_root_header *header_ptr;
						       FILE *F_X;
						       char *name; */);

/* Print on "F_X" the C text for the "header" of "header_ptr" */

extern void			X_root_reuse (/* X_root_header *header_ptr;
						 char *name;
						 int (*system_oflw)();
						 int (*user_oflw)();
						 int (*cmp)();
...
extern void			X_root_int_cpy (/* int *old_ptr;
						   int *new_ptr;
						   int old_size; */);
