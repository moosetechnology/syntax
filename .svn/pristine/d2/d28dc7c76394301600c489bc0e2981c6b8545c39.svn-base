...
extern BOOLEAN			X_root_set (X_root_header *header, 
					    SXUINT scramble, 
					    SXINT *ref);
...
extern BOOLEAN			X_root_write (X_root_header *header, filedesc_t F_X_root /* file descriptor */);
/* Write on "file" the structure "*header_ptr" */

extern BOOLEAN			X_root_read (X_root_header *header, filedesc_t F_X_root /* file descriptor */);
