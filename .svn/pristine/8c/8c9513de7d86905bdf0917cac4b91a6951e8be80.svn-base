...
SX_GLOBAL_VAR_CSYNT BOOLEAN is_automaton,
...
extern BOOLEAN  prdct_equal (SXINT xprdct, SXINT prdct1, SXINT prdct2);
extern SXINT	LALR1 (char *language_name), 
                OPTIM (char *language_name), 
...
extern VOID	sat_mess (char *name, SXINT no, SXINT old_size, SXINT new_size), 
		       ...
		       SXINT *M, 
		       SXINT *DELTA), 
                optim_lo (char *language_name, char *ME_optim_lo), 
                optim_ll (void), 
                optim_sizes (void), 
