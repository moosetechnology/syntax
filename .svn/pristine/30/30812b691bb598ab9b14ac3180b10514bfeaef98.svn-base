...
SX_GLOBAL_VAR long            vtime_out_s, vtime_out_us;
SX_GLOBAL_VAR SXLOGPROB          recognizer_scan_beam_value, recognizer_shift_beam_value, reducer_beam_value;
SX_GLOBAL_VAR SXLOGPROB          scan_rcvr_beam_delta, shift_rcvr_beam_delta;
SX_GLOBAL_VAR SXBOOLEAN	      recognizer_scan_beam_value_is_set, recognizer_shift_beam_value_is_set, recognizer_beam_type, reducer_beam_value_is_set, scan_rcvr_beam_delta_is_set, shift_rcvr_beam_delta_is_set;

SX_GLOBAL_VAR SXBOOLEAN       can_try_recognizer_beamrcvr;
