...
extern BOOLEAN	sxndparse_in_la (SXINT ep_la, SXINT Ttok_no, SXINT *Htok_no, struct sxparse_mode *mode_ptr);
extern BOOLEAN	sxnd2parser (SXINT what_to_do, struct sxtables *arg);
extern BOOLEAN	sxndparser (SXINT what_to_do, struct sxtables *arg);
extern BOOLEAN	sxndparse_clean_forest (void);
...
struct for_parsact {
    SXINT		(*action_top) (SXINT),
    		(*action_pop) (SXINT, SXINT, SXINT),
    		(*action_bot) (SXINT),
    		(*action_new_top) (SXINT, SXINT, SXINT),
    		(*action_final) (SXINT),
    		(*GC) (void),
      		(*post) (void),
                (*third_field) (SXINT*, char**),
                (*parsers_oflw) (SXINT, SXINT),
                (*sons_oflw) (SXINT, SXINT),
                (*symbols_oflw) (SXINT, SXINT),
        	(*post_td_init) (void),
        	(*post_td_action) (SXINT*),
        	(*post_td_final) (SXINT);
};
...
SXVOID	sxndtw_node_erase (SXINT node);
...
extern VOID 	ndlv_clear (struct sxndlv *ndlv, BOOLEAN keep_comments);
