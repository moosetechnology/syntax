...
/************************************************************************/
/* 20030505 15:31 (phd):	Amélioration de SOURCE_COORD (merci SGI)*/
/************************************************************************/
/* 20030423 15:26 (phd):	Plein de #define xxx xxx32		*/
/************************************************************************/
/* 20030328 13:04 (phd):	Ajout de "sxfile_copy"			*/
/************************************************************************/
/* 20030318 14:03 (phd):	Définition de "sxtime_v" et ses copains	*/
/************************************************************************/
/* 20030124 10:30 (pb):	        SXSTMI est lie' a` SXS_MAX      	*/
/************************************************************************/
/* 20021220 14:25 (pb&phd):	"new" est un mot-clef réservé en C++	*/
/************************************************************************/
/* 20020402 16:43 (pb&phd):	Modif de la lecture dans une chaine	*/
/************************************************************************/
/* 20010328 15:28 (pb):		Fusion 3.9 + 4.0 + 5.0			*/
/************************************************************************/
/* 20020320 17:03 (phd):	Définition de SX_DEV_{TTY,NUL}		*/
/************************************************************************/
/* 20020319 10:00 (phd):	"sxnewfile" et "sxfdopen"		*/
/************************************************************************/
/* 20001002 15:08 (phd):	Modifications diverses suite à la	*/
/*				demande d'utilisateurs (surtout VASY)	*/
/************************************************************************/
/* 20000622 14:47 (phd):	Définition de "register" => rien...	*/
/************************************************************************/
/* 20000620 17:32 (phd):	SXHASH_LENGTH: 1013=>8209		*/
/************************************************************************/
/* 20000607 14:18 (phd):	<strings.h> => <string.h>		*/
/************************************************************************/
/* 20000605 17:44 (pb&phd):	Fin de la modif des SX[PS]_SHORT, à	*/
/*				l'exception de sxparse_in_la ()		*/
/************************************************************************/
/* 19991201 13:37 (phd):	Ajout des divers sx[ps]s?recovery32	*/
/************************************************************************/
/* 19991126 17:45 (phd):	Définition de SXP_SHORT et SXS_SHORT	*/
/************************************************************************/
/* 19991020 11:40 (phd):	Définition de O_TEXT (pour Windows)	*/
/************************************************************************/
/* 14-10-99 14:10 (phd):	Ajout de "sxf(re)open" pour portabilité	*/
/************************************************************************/
/* 14-10-99 16:40 (phd) :	Définition de O_BINARY (pour Windows)	*/
/************************************************************************/
/* 17-09-99 18:50 (phd) :	SXCHAR_TO_STRING(), sxtolower() et	*/
/*				sxtoupper()				*/
/************************************************************************/
/* 05-04-94 10:30 (pb) :	Le SXBA de "sxindex_mngr" devient SXINT*	*/
/************************************************************************/
...
/************************************************************************/
/* 12-03-87 13:48 (pb):		S_seed_value passee en SXUINT	*/
/************************************************************************/
...
#define SCANACT_T SXINT(*)(SXINT what, ...)
/* the type SCANACT_T denotes 'a scan function, which can be stored in
   SXS_tables.scanact' */

#define SEMACT_T SXINT(*)(SXINT what, ...)
/* the type SEMACT_T denotes 'a semantic function which can be stored in
   SXP_tables.semact' */

#define RECOVERY_T SXBOOLEAN(*)(SXINT what, ...)
/* the type RECOVERY_T denotes 'a recovery function, which can be stored in
   SXS_tables.recovery' */
...
struct SXP_tables {
    ...
    SXP_SHORT   init_state, final_state;
    SXINT       Mprdct_list;
...
#define PARSER_T SXINT(*)(SXINT what, ...)
/* the type PARSER_T denotes 'a parsing function, which can be stored in
   sxtables.analyzers.parser' */

struct sxtables {
    SXUINT	magic;
    struct {
	SXINT	(*scanner) (SXINT what_to_do, struct sxtables *arg), (*parser) (SXINT what_to_do, ...);
    }	analyzers;
...
struct sxerr_info {
    SXUINT	file_ste /*	string table entry of source name	*/ ;
...
extern long sxtimediff (SXINT INIT_ou_ACTION);
...
/* extern FILE	*sxnewfile (char *name) : "name" sera passé à "mktemp" (qv) */
...
extern SXBOOLEAN sxfile_copy (char *in, char *out, long char_count, char *ME_sxfile_copy);

extern SXINT sxnext_prime (SXINT germe), sxlast_bit (SXINT nb);

extern SXVOID sort_by_tree (SXINT *t, SXINT bi, SXINT bs, BOOLEAN (*less_equal) (SXINT, SXINT));
...
extern char	*SXSTRGET (SXUINT ste);
extern SXUINT	SXSTRLEN (SXUINT ste);
SX_GLOBAL_VAR SXINT	SXIN_STRMACRO /* SX_INIT_VAL(0) */ ;
...
extern SXVOID sxsrcpush (SHORT previous_char, char *chars, struct sxsource_coord coord);
extern SXVOID sxX (SHORT inserted);
...
extern BOOLEAN sxparse_in_la (SXINT ep_la, SXINT Ttok_no, SXINT *Htok_no, struct sxparse_mode *mode_ptr);
...
extern SXVOID sxput_error (struct sxsource_coord	source_index, char *format, ...);
...
extern SXVOID sxatc_sub_tree_erase (/* NODE *node */ struct sxnode_header_s *node);
