...
/************************************************************************/
/* Mer 29 Avr 1998 10:29 (PB)	Ajout de cette rubrique "modifications"	*/
/************************************************************************/
...
static int		*Aij2tree;
static int		sons_stack [SXDRCGrhs_maxnt+1];
...
#if 0
static int		to_be_cloned [SXDRCGrhs_maxnt+1];
#endif
...
#if SXDRCGmax_atom!=0
static int atom2dynam_atom [SXDRCGmax_atom+1];
#endif
#endif
...
#if SXDRCGhas_prolog==1
{
    ...
    int			prod, ppp_item, init_ppp_item, next_ppp_item;
    SXBA		ppp_item_set;
    int			*ppp_prolon;
    ...
    int size;
{
    ...
    clone_stack = (int*) sxalloc ((clone_stack_size = SXDRCGrhs_maxnt+10) + 1, sizeof (int));
    clone2node = (int*) sxalloc ((clone2node_size = SXDRCGrhs_maxnt+10) + 1, sizeof (int));
