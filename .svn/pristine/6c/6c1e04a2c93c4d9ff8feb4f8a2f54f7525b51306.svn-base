...
static char	WHAT_cx_scnr [] = "@(#)cx_scnr.c	- SYNTAX [unix] - Mon Jul 21 14:35:43 2008";
...
SXVOID	cx_scan_it (void)
{
    ...
    sxuse (WHAT_cx_scnr); /* pour faire taire gcc -Wunused */
...
STATE_1:
    ...
    printf ("state_no = %ld, current_char = '%s', current_class = %d\n", 1, SXCHAR_TO_STRING (sxsrcmngr.current_char),
	 current_class);
...
STATE_25:
		    ...
		    default:
			/* Eof + "\000".."&" + "(".."/" + "8".."ÿ" */
			if (sxsvar.sxlv.mode.errors_nb++, (*sxsvar.SXS_tables.recovery) (SXACTION, 25, &current_class)) {
			    goto STATE_25;
			}
...
STATE_17:
    ...
    printf ("state_no = %ld, current_char = '%s', current_class = %d\n", 17, SXCHAR_TO_STRING (sxsrcmngr.current_char),
	 current_class);
...
STATE_19:
    ...
    printf ("state_no = %ld, current_char = '%s', current_class = %d\n", 19, SXCHAR_TO_STRING (sxsrcmngr.current_char),
	 current_class);
...
STATE_24:
    ...
    printf ("state_no = %ld, current_char = '%s', current_class = %d\n", 24, SXCHAR_TO_STRING (sxsrcmngr.current_char),
	 current_class);
