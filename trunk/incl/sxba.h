...
/* la macro SXBITS_PER_LONG contient la taille en bits d'un SXBA_ELT. Un meilleur
   ...
   Une definition intuitive pourrait etre : #define SXBITS_PER_LONG (8 * sizeof SXBA_ELT)
   ...
   C'est pourquoi on définit SXBITS_PER_LONG a l'aide de SXINT_SIZE
*/

#ifndef SXBITS_PER_LONG
#define SXBITS_PER_LONG SXINT_SIZE /* 32 ou 64 */
#endif
 ...
 *
 * In the early versions of SYNTAX, the type SXBA_INDEX (as well as
 * SXBA_INDEX_OR_ERROR) used to be 'int'.
 *
...
/* standard C, without GNU-specific extensions */
