...
char WHAT_CSYNT[] = "@(#)SYNTAX - $Id: csynt.c 3650 2023-12-23 07:32:10Z garavel $" WHAT_DEBUG;
...
{
    SXINT	*options_text_options_set;
    SXINT	i;
    bool	is_first = true;
...
static SXINT	csynt_run (char *ln)
{
	...
	/* absence de "break" (probablement intentionnel) */
...
/* valeurs par defaut */
    ...
    sxverbosep = false;
    is_force = is_list_system_conflicts = is_pspe = true;
