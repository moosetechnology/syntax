...
char WHAT_OPTIM[] = "@(#)SYNTAX - $Id: OPTIM.c 3650 2023-12-23 07:32:10Z garavel $" WHAT_DEBUG;
...
static bool	is_0_indistinguable (struct floyd_evans *afei, struct floyd_evans *afej)
{
...
static bool	is_k_indistinguable (struct floyd_evans *afei, struct floyd_evans *afej)
{
...
static void	insert_xt_lnk (SXINT xt, struct xt_to_act *xt_to_act)
{
...
void	fe_to_equiv (struct floyd_evans *afe1, struct floyd_evans *afe2)
{
    SXINT	k;
