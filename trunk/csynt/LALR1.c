...
char WHAT_LALR1[] = "@(#)SYNTAX - $Id: LALR1.c 3650 2023-12-23 07:32:10Z garavel $" WHAT_DEBUG;
...
extern bool	check_lr1 (SXINT xac1, SXBA t_set, SXINT nt_trans1, SXINT nt_trans2, bool is_duplicate, bool is_sample_path);
extern bool	check_ambig (SXINT t, SXINT item, SXINT nt_trans);
extern bool	open_listing (SXINT kind, char *ln, char *ME_open_listing, char *component_name);
...
static char	star_71 [] = "***********************************************************************";
static bool	is_lalr1, is_lr1, is_ambiguous;
...
static void	sature (SXINT sature_nbt)
{
...
static bool	is_old_StNt (SXINT state, SXINT nt, SXINT *StNt)
{
...
bool		t_in_deriv (SXINT t, SXINT t_in_deriv_item)
{
...
static void	cutback (SXINT St1, SXINT cutback_item, SXINT StNt, SXINT q, SXINT q1, bool to_be_cut)
{
    SXINT	x, St;
    SXINT		StNt1;
...
static void	fill_look_ahead_set (SXINT *fill_lookahead_set_items_set, SXBA la_set)
{
...
/* Calcul de la relation includes */
	...
	if (is_lr1_constructor) {
	    ...
	    SXBA	la_set_r1;
	    SXINT		r1;
	    bool	LALR1_is_lalr1, LALR1_is_lr1;
