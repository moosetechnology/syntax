...
char WHAT_ALGOV[] = "@(#)SYNTAX - $Id: algoV.c 3650 2023-12-23 07:32:10Z garavel $" WHAT_DEBUG;
...
static bool	is_compatible (struct item *avector, struct item *aitem, struct item *lim)
{
    SXINT	act, actpi, t;
    struct item	*pi;
