...
c  File name: fd1d_heat_steady/problem3.f
c
      program main

c*********************************************************************72
c
cc MAIN is the main program for problem 3.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc K3 evaluates the heat transfer coefficient K(X).
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
...
c
c    Output, double precision K3, the value of K(X).
c
      implicit none
...
c*********************************************************************72
c
cc F3 evaluates the right hand side of the steady state heat equation.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license.
