...
c  File name: templated/templated.f
c
*
...
*     .. Local Scalars ..
     ...
     $                   NEED1, NEED2
      DOUBLE PRECISION   TOL, ALPHA, BETA, RHO, RHO1, BNRM2, RHOTOL, 
     $                   GETBREAK, DDOT, DNRM2
*
...
*     .. Local Scalars ..
     ...
     $                   MAXIT, NEED1, NEED2
      DOUBLE PRECISION   TOL, ALPHA, BETA, BNRM2, RHO, RHO1, RHOTOL, 
     $                   GETBREAK, DDOT, DNRM2
*     ..
*     indicates where to resume from. Only valid when IJOB = 2!
      INTEGER RLBL
...
*
            ...
            CALL DAXPY( N, ONE, WORK(1,U), 1, WORK(1,P), 1 )
         ELSE
            CALL DCOPY( N, WORK(1,R), 1, WORK(1,U), 1 )
...
*
         ...
         CALL DAXPY( N, ONE, WORK(1,U), 1, WORK(1,PHAT), 1 )
...
*
      END
      DOUBLE PRECISION FUNCTION DLARAN2( ISEED )
*
*  -- LAPACK auxiliary routine (version 1.1) --
*     Univ. of Tennessee, Univ. of California Berkeley, NAG Ltd.,
*     Courant Institute, Argonne National Lab, and Rice University
