...
c  File name: fftpack5/fftpack5.f
c
...
c  Licensing:
c
c    This code is distributed under the GNU General Public License (GPL).
c
c  Modified:
c
c    30 November 2009
...
c  Author: 
c
c    Paul Swarztrauber, Richard Valent
c
...
c  Discussion:
c
c    On 10 May 2010, this code was modified by changing the value
c    of an index into the WSAVE array.
c
