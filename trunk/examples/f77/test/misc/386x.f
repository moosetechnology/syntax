...
c*********************************************************************72
c
cc COL adds a multiple of vector V2 to vector V1.
c
c  Discussion:
c
c    Elements 1 through K of V2 are added to V1, excluding
c    element NOTROW.
c
c  Modified:
c
...
c  Parameters:
c
c    Input/output, real V1(K), ?
c
c    Input, real V2(K), ?
c
c    Input, real XMLT, the multiplier.
c
c    Input, integer NOTROW, the entry of V1 that is not to be changed.
c
c    Input, integer K, the dimension of V1 and V2.
c
      implicit none
