...
c  File name: matrix_exponential/matrix_exponential.f
c
      subroutine expm1 ( n, a, e )

c*********************************************************************72
c
cc EXPM1 is essentially MATLAB's built-in matrix exponential algorithm.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc EXPM2 uses the Taylor series for the matrix exponential.
c
c  Discussion:
c
c    Formally,
...
c*********************************************************************72
c
cc EXPM3 approximates the matrix exponential using an eigenvalue approach.
c
c  Discussion:
c
c    exp(A) = V * D * V
