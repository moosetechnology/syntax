...
c  File name: fftpack5/sint_test.f
c
      program main

c*********************************************************************72
c
cc SINT_TEST tests SINT1B, SINT1F, SINT1I.
c
c  Licensing:
c
...
c
      ...
      integer lenwrk
      parameter ( lenwrk = 8194 )

      integer lensav
      parameter ( lensav = 6156 )
...
c*********************************************************************72
c
cc R4VEC_PRINT_SOME prints "some" of a R4VEC.
c
c  Discussion:
c
