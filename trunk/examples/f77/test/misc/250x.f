...
c  File name: machine/machine_prb.f
c
      program main
...
c  Discussion:
c
c    MACHINE_PRB runs the MACHINE tests.
c
c  Licensing:
c
...
c*********************************************************************72
c
cc D1MACHINE_PRB reports the constants returned by D1MACH.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc I1MACHINE_PRB reports the constants returned by I1MACH.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
...
c*********************************************************************72
c
cc R1MACHINE_PRB reports the constants returned by R1MACH.
c
c  Licensing:
c
c    This code is distributed under the GNU LGPL license. 
