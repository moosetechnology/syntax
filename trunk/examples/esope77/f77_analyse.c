...
static bool check_for_a_lhs (SXINT tok_no)
{
    ...
    */
    SXINT lahead = sxget_token (tok_no + 1)->lahead;
    bool  ret_val;
#if EBUG
...
static void process_initial_id (SXINT Mtok_no)
{
    ...
    fprintf (stdout,
	     "**************** Entering process_initial_id (after_logical_if = %s) ****************\n",
