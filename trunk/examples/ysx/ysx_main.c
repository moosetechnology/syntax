...
char WHAT_YSXMAIN[] = "@(#)SYNTAX - $Id: ysx_main.c 4254 2024-09-06 08:25:37Z garavel $" WHAT_DEBUG;

extern SXTABLES	ysx_tables;
extern SXTABLES	yaction_tables;

extern SXSCANACT_FUNCTION yaction_scanact;
...
int main (int argc, char *argv[])
{
  ...
  sxset_scanner_action (yaction_tables, yaction_scanact);
