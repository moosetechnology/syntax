...
SX_GLOBAL_VAR_NBEST SXLOGPROB nbest_get_weight (SXINT root_Aij, SXINT h, SXINT cur_contextual_proba_kind);
...
SX_GLOBAL_VAR_NBEST SXLOGPROB get_Tpq_logprob (SXINT item, SXINT cur_contextual_proba_kind);
SX_GLOBAL_VAR_NBEST void   nbest_seek_kth_best_tree (SXINT Aij_or_item, SXINT k, void (*f) (SXINT Pij, SXLOGPROB weight));
...
SX_GLOBAL_VAR_NBEST SXLOGPROB              min_logprob;
...
SX_GLOBAL_VAR SXLOGPROB       min_logprob_fs; /* Proba min des f_structures */
...
SX_GLOBAL_VAR SXLOGPROB       full_ctxtXeprod2logprobs [], eprod_ctxtXeprod2logprobs [], prod_ctxtXeprod2logprobs [],
...
SX_GLOBAL_VAR SXLOGPROB       lex_id2logprobs [], full_ctxtXlex_id2logprobs [], eprod_ctxtXlex_id2logprobs [], prod_ctxtXlex_id2logprobs [],
                    A_ctxtXlex_id2logprobs [];

SX_GLOBAL_VAR XxY_header   ctxtXsign_hd;
SX_GLOBAL_VAR SXLOGPROB       ctxtXsign2logprobs [];
