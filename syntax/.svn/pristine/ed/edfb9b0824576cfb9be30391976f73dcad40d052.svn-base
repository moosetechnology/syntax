...
/* !!! sxunix et donc sxu2 sont inclus dans sxtm_mngr, qui définit ces fonctions... et où elles ne sont donc pas trop extern... */
...
#define sxstrretrieve(string) ({ char *strvar = (string); sxstr_retrievelen (&sxstrmngr, strvar, strlen (strvar)); })
#define sxstrsave(string) ({ char *strvar = (string); sxstr_savelen (&sxstrmngr, strvar, strlen (strvar)); })
...
extern SXVOID sxput_error (struct sxsource_coord source_index, char *format, ...) __attribute__((__deprecated__)) ;
