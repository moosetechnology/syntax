...
extern BOOLEAN	sxdp_write (filedesc_t file_descr /* file descriptor */);
extern BOOLEAN	sxdp_read (filedesc_t file_descr /* file descriptor */);
...
extern BOOLEAN	sxdp_rule_is_activated (SXINT rule);
extern BOOLEAN	sxdp_rule_set (SXINT rhs_lgth, SXINT *symbols, SXINT *rule, SXINT action_nb, SXINT prio, SXINT assoc);
...
extern BOOLEAN	sxdp_new_xt (SXINT t, SXINT prdct, SXINT *xt, SXINT prio, SXINT assoc);
extern BOOLEAN	sxdp_new_xnt (SXINT nt, SXINT prdct, SXINT *xnt);
extern SXVOID	sxdp_delete_xt (SXINT xt);
extern SXVOID	sxdp_delete_xnt (SXINT xnt);
extern BOOLEAN	sxdp_add_new_state (SXINT transition, SXINT *result);
