...
extern BOOLEAN	IS_AND (SXBA lhs_bits_array, SXBA rhs_bits_array);

SX_GLOBAL_VAR_RCG long		options_set;
SX_GLOBAL_VAR_RCG BOOLEAN		is_listing_output, check_self_definition, is_CF_parser, check_set, is_OLTAG, is_1_RCG, is_gen_bnf;
SX_GLOBAL_VAR_RCG BOOLEAN		decrease_order, is_simple, is_proper, is_2var_form, is_factorize, is_combinatorial, is_full_lex;
SX_GLOBAL_VAR_RCG BOOLEAN		is_left_corner, used_nfndfsa, is_first_last, is_look_ahead, is_tagger, is_shift_reduce, is_shallow;
SX_GLOBAL_VAR_RCG BOOLEAN         is_keep_lex, is_keep_epsilon_rules, check_instantiable_clause;
SX_GLOBAL_VAR_RCG SXINT             h_value;
SX_GLOBAL_VAR_RCG char		*prgentname, *suffixname, *lfsa_file_name, *rfsa_file_name, *shallow_file_name, *lbnf_file_name, *rbnf_file_name, *Lex_file_name, *lrprod_file_name, *tig_file_name;
SX_GLOBAL_VAR_RCG char	by_mess [];
SX_GLOBAL_VAR_RCG FILE		*listing, *lfsa_file, *rfsa_file, *useless_clause_file, *shallow_file, *lbnf_file, *rbnf_file, *Lex_file, *lrprod_file, *tig_file;
...
SX_GLOBAL_VAR_RCG BOOLEAN		is_drcg;
...
SX_GLOBAL_VAR_RCG BOOLEAN		sxttycol1p, is_start_symbol_in_rhs, has_first_last_pp, has_sem_act;
SX_GLOBAL_VAR_RCG BOOLEAN		is_bottom_up_erasing, is_top_down_erasing, is_left_linear, is_right_linear, is_loop_grammar, is_combinatorial_grammar;
SX_GLOBAL_VAR_RCG BOOLEAN         is_proper_grammar, is_simple_grammar;
...
SX_GLOBAL_VAR_RCG BOOLEAN		has_identical_clauses, has_identical_nts;
...
SX_GLOBAL_VAR_RCG BOOLEAN         is_negative;
