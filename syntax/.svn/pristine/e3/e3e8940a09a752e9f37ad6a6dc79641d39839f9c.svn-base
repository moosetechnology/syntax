...
#define X_root_Xtotal_sizeof(h)						\
   (									\
    ((h).hash_display == NULL ? 0 : sizeof(int)*(h).hash_size)+		\
    ((h).hash_lnk == NULL ? 0 : sizeof(int)*(h).size)+ 			\
...
#define X_root_Xused_sizeof(h)						\
   (									\
    ((h).hash_display == NULL ? 0 : sizeof(int)*(h).hash_size)+		\
    ((h).hash_lnk == NULL ? 0 : sizeof(int)*(h).top)+			\
...
#define X_root_XYtotal_sizeof(h)						\
   (										\
    ((h).hash_display == NULL ? 0 : sizeof(int)*(h).hash_size)+			\
    ((h).hash_lnk == NULL ? 0 : sizeof(int)*((h).size+1))+			\
    ...
    ((h).lnk_hd [0] == NULL ? 0 : sizeof(int)*(X_size(*((h).X_hd [0]))+1))+	\
    ((h).lnk_hd [1] == NULL ? 0 : sizeof(int)*(X_size(*((h).X_hd [1]))+1))+	\
    ((h).lnk [0] == NULL ? 0 : sizeof(int)*((h).size+1))+			\
    ((h).lnk [1] == NULL ? 0 : sizeof(int)*((h).size+1))			\
   )

#define X_root_XYused_sizeof(h)							\
   (										\
    ((h).hash_display == NULL ? 0 : sizeof(int)*(h).hash_size)+			\
    ((h).hash_lnk == NULL ? 0 : sizeof(int)*((h).top+1))+			\
    ...
    ((h).lnk_hd [0] == NULL ? 0 : sizeof(int)*(X_top(*((h).X_hd [0]))+1))+	\
    ((h).lnk_hd [1] == NULL ? 0 : sizeof(int)*(X_top(*((h).X_hd [1]))+1))+	\
    ((h).lnk [0] == NULL ? 0 : sizeof(int)*((h).top+1))+			\
    ((h).lnk [1] == NULL ? 0 : sizeof(int)*((h).top+1))				\
   )
...
#define X_root_XYZtotal_sizeof(h)						\
   (										\
    ...
    ((h).lnk_hd [0] == NULL ? 0 : sizeof(int)*(X_size(*((h).X_hd [0]))+1))+	\
    ((h).lnk_hd [1] == NULL ? 0 : sizeof(int)*(X_size(*((h).X_hd [1]))+1))+	\
    ((h).lnk_hd [2] == NULL ? 0 : sizeof(int)*(X_size(*((h).X_hd [2]))+1))+	\
    ((h).lnk_hd [3] == NULL ? 0 : sizeof(int)*(XxY_size(*((h).XxY_hd [0]))+1))+	\
    ((h).lnk_hd [4] == NULL ? 0 : sizeof(int)*(XxY_size(*((h).XxY_hd [1]))+1))+	\
    ((h).lnk_hd [5] == NULL ? 0 : sizeof(int)*(XxY_size(*((h).XxY_hd [2]))+1))+	\
    ((h).lnk [0] == NULL ? 0 : sizeof(int)*((h).size+1))+			\
    ((h).lnk [1] == NULL ? 0 : sizeof(int)*((h).size+1))+			\
    ((h).lnk [2] == NULL ? 0 : sizeof(int)*((h).size+1))+			\
    ((h).lnk [3] == NULL ? 0 : sizeof(int)*((h).size+1))+			\
    ((h).lnk [4] == NULL ? 0 : sizeof(int)*((h).size+1))+			\
    ((h).lnk [5] == NULL ? 0 : sizeof(int)*((h).size+1))			\
   )
...
#define X_root_XYZused_sizeof(h)						\
   (										\
    ...
    ((h).lnk_hd [0] == NULL ? 0 : sizeof(int)*(X_top(*((h).X_hd [0]))+1))+	\
    ((h).lnk_hd [1] == NULL ? 0 : sizeof(int)*(X_top(*((h).X_hd [1]))+1))+	\
    ((h).lnk_hd [2] == NULL ? 0 : sizeof(int)*(X_top(*((h).X_hd [2]))+1))+	\
    ((h).lnk_hd [3] == NULL ? 0 : sizeof(int)*(XxY_top(*((h).XxY_hd [0]))+1))+	\
    ((h).lnk_hd [4] == NULL ? 0 : sizeof(int)*(XxY_top(*((h).XxY_hd [1]))+1))+	\
    ((h).lnk_hd [5] == NULL ? 0 : sizeof(int)*(XxY_top(*((h).XxY_hd [2]))+1))+	\
    ((h).lnk [0] == NULL ? 0 : sizeof(int)*((h).top+1))+			\
    ((h).lnk [1] == NULL ? 0 : sizeof(int)*((h).top+1))+			\
    ((h).lnk [2] == NULL ? 0 : sizeof(int)*((h).top+1))+			\
    ((h).lnk [3] == NULL ? 0 : sizeof(int)*((h).top+1))+			\
    ((h).lnk [4] == NULL ? 0 : sizeof(int)*((h).top+1))+			\
    ((h).lnk [5] == NULL ? 0 : sizeof(int)*((h).top+1))				\
   )
