...
extern void			sxsubset_alloc (); /* (header_ptr,
						      subset_nb,
						      cardinal,
						      subset_oflw,
						      elem_oflw,
						      stat_file) */
extern void			sxsubset_free (); /* (header_ptr) */
extern void			sxsubset_elem_oflw (); /* (header_ptr, new_cardinal) */
extern int			sxsubset_set (); /* (header_ptr, subset_nb) */
...
extern void			sxsubset_stat (); /* (stat_file, header_ptr) */
extern BOOLEAN			sxsubset_write (); /* (header_ptr, file_descr) */
extern BOOLEAN			sxsubset_read (); /* (header_ptr,
						    file_descr,
						    name,
						    subset_oflw,
						    elem_oflw,
						    stat_file) */
extern void			sxsubset_array_to_c (); /* (header_ptr, file, name) */
extern void			sxsubset_header_to_c (); /* (header_ptr, file, name) */
extern void			sxsubset_to_c (); /* (header_ptr,
						   file,
						   name,
						   is_static) */
extern void			sxsubset_reuse (); /* (header_ptr,
						    subset_oflw,
						    elem_oflw,
						    stat_file) */
