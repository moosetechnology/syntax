...
extern SXUINT	sxword_save (sxword_header *header, char *string);
extern SXUINT	sxword_2save (sxword_header *header, char *string, SXUINT sxword_2save_strlen);
extern SXUINT	sxword_retrieve (sxword_header *header, char *string);
extern SXUINT	sxword_2retrieve (sxword_header *header, char *string, SXUINT strlength);
extern void		sxword_stat (sxword_header *header, FILE *stat_file);
extern BOOLEAN		sxword_write (sxword_header *header, filedesc_t file_descr);
extern BOOLEAN		sxword_read (sxword_header *header,
...
extern char*		sxword_get (sxword_header *header, SXUINT ste);
extern SXUINT	sxword_len (sxword_header *header, SXUINT ste);
