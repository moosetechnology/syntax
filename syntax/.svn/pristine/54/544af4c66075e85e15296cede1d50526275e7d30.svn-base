...
struct spf /* shared_parse_forest */ {
  ...
  struct walk {
    ...
    SXINT 	(*pass_inherited) (SXINT) /* variable locale */
	 ...
	 , (*post_pass) (SXINT, BOOLEAN) /* variable locale */
...
SX_GLOBAL_VAR BOOLEAN          spf_print_iprod (FILE *out_file, SXINT prod, char *prefix, char *suffix);
...
SX_GLOBAL_VAR BOOLEAN          spf_topological_walk (SXINT root,
						     SXINT (*pi)(SXINT),
						     SXINT (*pd)(SXINT));
/* Permettent des pre et/ou des post visites sur les noeuds Aij des Aij-iprods */
SX_GLOBAL_VAR BOOLEAN          spf_topological_top_down_walk (SXINT root,
							      SXINT (*pi)(SXINT),
							      SXINT (*pre_pass)(SXINT),
							      SXINT (*post_pass)(SXINT, BOOLEAN));
SX_GLOBAL_VAR BOOLEAN          spf_topological_bottom_up_walk (SXINT root,
							       SXINT (*pd)(SXINT),
							       SXINT (*pre_pass)(SXINT),
							       SXINT (*post_pass)(SXINT, BOOLEAN));
...
SX_GLOBAL_VAR BOOLEAN          spf_make_proper (SXINT root_Aij);
...
SX_GLOBAL_VAR void             spf_yield2dfa (BOOLEAN which_form /* TRUE => UDAG */);
