...
#ifndef VARIANT_32
char WHAT_SXNDS_RECOVERY[] = "@(#)SYNTAX - $Id: sxnds_rcvr.c 1027 2008-02-14 10:04:31Z rlacroix $" WHAT_DEBUG;
#else
char WHAT_SXNDS_RECOVERY[] = "@(#)SYNTAX - $Id: sxnds_rcvr.c 1027 2008-02-14 10:04:31Z rlacroix $ SXNDS_RCVR_32" WHAT_DEBUG;
#endif
...
static BOOLEAN	is_insertable (SXSTMI *tm_line, SXSTMI stmt, SXSHORT *sample)
{
...
static BOOLEAN backward_traversal (SXINT node, SXINT stmt, SXINT j)
{
...
static BOOLEAN	nds_recovery (void)
{
...
BOOLEAN		sxndsrecovery (SXINT sxndsrecovery_what)
{
