...
char WHAT_SXAT_MNGR[] = "@(#)SYNTAX - $Id: sxat_mngr.c 1048 2008-02-15 08:41:23Z rlacroix $" WHAT_DEBUG;

NODE	*sxbrother (/* struct sxnode_header_s */ void *visited_void, SXINT n)
{
    NODE	*brother;
    SXINT	pos;
...
NODE	*sxson (/* struct sxnode_header_s */ void *visited, SXINT n)
{
    NODE	*son = ((struct sxnode_header_s*)visited)->son;
    SXINT	pos = 1;
