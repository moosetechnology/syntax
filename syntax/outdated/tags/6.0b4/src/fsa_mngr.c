...
char WHAT_SXDAG_MNGR[] = "@(#)SYNTAX - $Id: fsa_mngr.c 1228 2008-03-28 13:23:03Z sagot $" WHAT_DEBUG;
...
char WHAT_FSA_TO_RE[] = "@(#)SYNTAX - $Id: fsa_mngr.c 1228 2008-03-28 13:23:03Z sagot $" WHAT_DEBUG;
...
print_code (VARSTR vstr, SXINT code)
{
  ...
  if (trans_kind == ATOMIC_TRANS) {
    ...
    vstr = varstr_lcatenate_with_escape (vstr, trans_name, strlen (trans_name), "?*+");
  }
  else {
    bot = XH_X (code_hd, id);
