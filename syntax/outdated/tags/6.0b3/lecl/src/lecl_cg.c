...
#include "lecl_ag.h"
#include "sxsstmt.h"
char WHAT_LECLCG[] = "@(#)SYNTAX - $Id: lecl_cg.c 1114 2008-02-27 15:13:51Z rlacroix $" WHAT_DEBUG;

static SXINT	gen_action_code (SXINT V, BOOLEAN is_keep, BOOLEAN is_scan, SXINT ref, SXINT codop);
static SXINT	install_action (struct action_or_prdct_code_item fe);
static BOOLEAN	is_unique (transition_matrix_item *is_unique_stmt) /* bullshit */ ;
...
extern SXINT	get_a_partition (BOOLEAN (*)(SXINT, SXINT, SXINT), 
				 SXINT (*)(SXINT, SXINT), 
				 SXBA, 
				 SXINT, 
				 SXINT, 
...

static BOOLEAN	less_equal (SXINT less_equal_i, SXINT less_equal_j)
{
    SXBA	lj;
    SXINT	less_equal_x;
...
static BOOLEAN	equal (SXINT equal_i, SXINT equal_j)
{
...
static VARSTR	token_name_list (SXBA token_set, VARSTR string)
{
    SXINT		token_name_list_x, ner;
...
static BOOLEAN	re_erased (SXINT re_erased_re_no)
{
...

static transition_matrix_item	test_ref (BOOLEAN is_keep, BOOLEAN is_scan, SXINT codop, SXINT ref)
{
...
static VOID gen_nondeter_code (SXINT V, BOOLEAN is_keep, BOOLEAN is_scan, SXINT ref, SXINT codop)
{
...
static VOID gen_prdct_code (SXINT V, BOOLEAN is_keep, BOOLEAN is_scan, SXINT ref, SXINT codop)
{
    struct action_or_prdct_code_item	fe;
    char	*string;
    char	first;
...
static BOOLEAN	is_compatible (SXINT statei, SXINT statej, SXINT symbole)
{
...
static BOOLEAN	is_in_a_lane (SXINT action)
{
...
static BOOLEAN	is_utp (transition_matrix_item *is_utp_stmt)
{
    if (SCAN (*is_utp_stmt)) {
	return TRUE;
    }
...
static BOOLEAN	is_unique (transition_matrix_item *is_unique_stmt)
{
    BOOLEAN	is_first, is_equal;
...
static BOOLEAN is_covered (SXINT is_covered_x)
{
...
static BOOLEAN non_unique (SXINT xtrans)
{
...
static BOOLEAN	forward_look_ahead (SXINT current_state)
{
