...
#include "lecl_node.h"
char WHAT_LECLCSS[] = "@(#)SYNTAX - $Id: lecl_css.c 1114 2008-02-27 15:13:51Z rlacroix $" WHAT_DEBUG;

extern BOOLEAN	lecl_check_octal_code (SXINT, struct sxsource_coord, SXINT *);
