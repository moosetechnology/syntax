...
#include "lecl_ag.h"
#include "put_edit.h"
char WHAT_LECLLO[] = "@(#)SYNTAX - $Id: lecl_lo.c 1114 2008-02-27 15:13:51Z rlacroix $" WHAT_DEBUG;
...
extern VARSTR	lecl_gen_sc (SXBA *SC_TO_CHAR_SET, 
			     SXINT simple_class, 
			     VARSTR varstr_ptr);
extern VOID	equality_sort (SXINT *t, SXINT bi, SXINT bs, BOOLEAN (*less_equal) (SXINT, SXINT), BOOLEAN (*equal) (SXINT, SXINT));
...
static char	*cv_delete (char *cv_delete_s, BOOLEAN del)
{
    if (del)
...
static BOOLEAN	less_prdct (SXINT less_prdct_i, SXINT less_prdct_j)
{
...
static BOOLEAN	compare_kw (SXINT compare_kw_i, SXINT compare_kw_j)
{
    char	*si, *sj;
