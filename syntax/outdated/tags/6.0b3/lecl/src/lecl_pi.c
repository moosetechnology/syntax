...
#include "lecl_nn.h"
char WHAT_LECLPI[] = "@(#)SYNTAX - $Id: lecl_pi.c 1114 2008-02-27 15:13:51Z rlacroix $" WHAT_DEBUG;
...
VOID	lecl_pi (void)
{
    struct lecl_node	*visited = VISITED;
...
/* VISITED->name = {EXPRESSION_n, IS_FIRST_COL_n, IS_LAST_COL_n, IS_RESET_n, IS_SET_n, PRDCT_ET_n, PRDCT_NOT_n, PREDICATE_NAME_n, PREDICATE_NO_n} */
	...
	case 2:
	    ...
	    ers = (struct ers_item*) sxalloc ((SXINT) ers_size + 1, sizeof (struct ers_item));
