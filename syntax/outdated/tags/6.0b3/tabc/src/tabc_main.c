...
#include "tabc_vars.h"
#endif
char WHAT_TABCMAIN[] = "@(#)SYNTAX - $Id: tabc_main.c 1209 2008-03-12 15:58:48Z rlacroix $" WHAT_DEBUG;
...
extern BOOLEAN	tab_sem (void);
extern VOID	tabc_lo (void);
extern VOID	tabc_free (void);
