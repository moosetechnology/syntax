...
extern BOOLEAN			X_set (X_header *header,
				       SXINT X,
				       SXINT *result_ptr);
...
extern BOOLEAN			X_write (X_header *header, filedesc_t file /* file descriptor */);
/* Write on "file" the structure "*header" */

extern BOOLEAN			X_read (X_header *header, 
					filedesc_t file /* file descriptor */, 
					char *name, 
					void (*user_oflw) (SXINT, SXINT), 
					FILE *stat_file);
