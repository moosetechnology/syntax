/* C'est une copie le Jeu 28 mars 2002 de la version 5.0 de xcsynt/optim_lo.c */
...
/*				deterministes sont superieurs a 20000	*/
/*				(et non plus a 10000)			*/
/************************************************************************/
...
#include "bstr.h"
char WHAT_OPTIMLO[] = "@(#)SYNTAX - $Id: optim_lo.c 1103 2008-02-25 15:22:05Z rlacroix $" WHAT_DEBUG;
...
BOOLEAN		open_listing (SXINT kind, char *language_name, char *ME, char *component_name)
{
    struct bstr	*bstr;
#include <time.h>
...
VOID	optim_lo (char *language_name, char *ME)
{
    static char		hyph60 [] = "-------------------------------------------------------------";
    static char		dot46 [] = ".............................................";
    SXINT	i, x, y, l;
    ...
    open_listing ((SXINT)2, language_name, ME, ".op.l");
    stats.nt.c.cols = 0;
