...
char WHAT_RCG1RCG2VAR[] = "@(#)SYNTAX - $Id: rcg_1rcg_2var.c 1143 2008-03-05 16:22:39Z rlacroix $" WHAT_DEBUG;

extern BOOLEAN is_arg_in_Tstar (SXINT param);
...
static void
gen_symb (SXINT symb, BOOLEAN *is_first)
{
...
static void
gen_arg (SXINT bot, SXINT top, BOOLEAN *is_first)
{
    SXINT pos;
...
static SXINT
lhs_gen_or_degree (struct arg2bot_top *p, SXINT arity, BOOLEAN is_gen/* , is_main */)
{
...
static SXINT
print_new_prdct (BOOLEAN is_lhs, SXINT cur)
{
...
static void rcg2bnf (BOOLEAN is_print);
...
static VARSTR
get_UBs (SXINT t, BOOLEAN *has_UBs)
{
