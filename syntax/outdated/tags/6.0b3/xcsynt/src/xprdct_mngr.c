...
char WHAT_XCSYNTXPRDCTMNGR[] = "@(#)SYNTAX - $Id: xprdct_mngr.c 1128 2008-03-04 11:49:22Z rlacroix $" WHAT_DEBUG;
...
static SXINT	gen_brothers (SXINT codop, SXINT left_son)
{
...
BOOLEAN		prdct_equal (SXINT xprdct, SXINT prdct1, SXINT prdct2)
{
...
SXVOID build_branch (SXINT xprdct, struct floyd_evans *fe, SXINT father)
{
...
SXINT	gen_tree (SXINT codop, SXINT father)
{
