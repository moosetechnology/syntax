...
char WHAT_XCSYNTARP[] = "@(#)SYNTAX - $Id: ARP.c 1128 2008-03-04 11:49:22Z rlacroix $" WHAT_DEBUG;
...
static BOOLEAN	ARP_is_final_state (SXINT ARP_state)
{
...
static BOOLEAN	ARP_is_ambiguous (struct ARC_struct *XARC, 
				  SXINT XARC_state, 
				  SXINT ARP_state)
{
...
BOOLEAN PARTIAL_FSA_ARP_construction (struct ARC_struct *XARC, SXINT bfsa1, SXINT bfsa2)
{
  SXINT	ARP_state;
