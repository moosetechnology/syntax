...
char WHAT_XCSYNTFIRST[] = "@(#)SYNTAX - $Id: first.c 1128 2008-03-04 11:49:22Z rlacroix $" WHAT_DEBUG;
...
static BOOLEAN		(*parse_completed)(SXINT, SXINT, BOOLEAN);
...
static BOOLEAN prefixe (SXINT item, SXINT t_ref)
{
...
BOOLEAN earley_parse (SXINT LA_init, SXINT LA_final, XH_header *hd, SXINT item, BOOLEAN (*F)(SXINT, SXINT, BOOLEAN))
{
    stack_hd = hd;
    LA_top = LA_final;
    parse_completed = F;
