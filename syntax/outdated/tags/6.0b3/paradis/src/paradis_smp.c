...
#include "sem_by.h"
#include "varstr.h"
char WHAT_PARADISSMP[] = "@(#)SYNTAX - $Id: paradis_smp.c 1110 2008-02-26 09:40:42Z rlacroix $" WHAT_DEBUG;
...
#if 0
static SXVOID	put_c_in_line (char c)
{
    line [xline] = c;
...
/* A L L O C A T I O N S   */
    ...
    PP_ag.PP_indx = (SXINT*) sxalloc (PP_ag.PP_constants.PP_indx_lgth + 1, sizeof (SXINT));
