...
#include "sxunix.h"
#include "ppada_td.h"
char WHAT_PPADAMAIN[] = "@(#)SYNTAX - $Id: ppada_main.c 1209 2008-03-12 15:58:48Z rlacroix $" WHAT_DEBUG;
...
extern BOOLEAN ppada_scan_act (SXINT code, SXINT act_no);

/*---------------*/
/*    options    */
/*---------------*/

BOOLEAN		ppada_verbose;
