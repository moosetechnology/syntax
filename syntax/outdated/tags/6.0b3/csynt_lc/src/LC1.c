...
/************************************************************************/
/* 20050315 15:54 (phd):	"eof" est utilisé par MINGW		*/
/************************************************************************/
...
char WHAT_LC1[] = "@(#)SYNTAX - $Id: LC1.c 1105 2008-02-26 09:40:03Z rlacroix $" WHAT_DEBUG;
...
BOOLEAN		open_listing (SXINT kind, char *open_listing_language_name, char *open_listing_ME, char *component_name)
{
    struct bstr	*bstr;
