...
/* sxsyntax appelle
   ...
   du parser appelle
   (*(sxplocals.SXP_tables.semact)) (ACTION, &for_semact);
    ...
    int S0n;
{
    ...
    features_action (ACTION, &for_features);
