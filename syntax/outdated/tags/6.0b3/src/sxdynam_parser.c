...
char WHAT_SXDYNAM_PARSER[] = "@(#)SYNTAX - $Id: sxdynam_parser.c 1014 2008-02-13 08:37:34Z rlacroix $" WHAT_DEBUG;
...
BOOLEAN
sxdp_write (filedesc_t file_descr /* file descriptor */ )
{
...
BOOLEAN
sxdp_read (filedesc_t file_descr /* file descriptor */)
{
