...
char WHAT_FERMER[] = "@(#)SYNTAX - $Id: fermer.c 1002 2008-02-11 15:25:17Z rlacroix $" WHAT_DEBUG;
 ...
 */
{
  ...
  SXBA_ELT  lhs_size = BASIZE (lhs_bits_array), rhs_size = BASIZE (rhs_bits_array);
  SXBA_ELT  slices_number = NBLONGS (lhs_size);
 ...
 */
{
  SXBA_ELT    size1 = BASIZE (bits_array_1), size2 = BASIZE (bits_array_2);
