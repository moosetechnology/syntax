...
/************************************************************************/
/* Mar 26 Nov 1996 11:25(pb):	Adaptation a LINUX			*/
/************************************************************************/
/* 21-01-94 14:19 (pb):		Caractere de "char" a "int"		*/
/************************************************************************/
...
/************************************************************************/
/* 06-03-87 17:36 (p):	Suppression de l'option "check"	   		*/
/************************************************************************/
/* 13-02-87 14:43 (phd):	Mode verbose plus agreable		*/
/************************************************************************/
/* 26-11-86 10:11 (phd&pb) :	Lecture sur stdin (voir bnf)	 	*/
/************************************************************************/
/* 13-11-86 14:40 (pb) :	Changement dans la grammaire:	 	*/
...
#include <sys/types.h>
#include <sys/stat.h>
char WHAT_PARADISMAIN[] = "@(#)SYNTAX - $Id: paradis_main.c 580 2007-05-24 12:45:54Z rlacroix $" WHAT_DEBUG;
...
extern VOID	no_tables (), bnf_lo (), paradis_lo ();
extern BOOLEAN	paradis_sem ();
