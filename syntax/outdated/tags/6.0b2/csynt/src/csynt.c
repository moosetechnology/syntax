...
#include "release.h"
#include "bstr.h"
char WHAT_CSYNT[] = "@(#)SYNTAX - $Id: csynt.c 597 2007-05-28 14:05:15Z rlacroix $" WHAT_DEBUG;
...
struct bstr	*options_text (kind, bstr)
    ...
    struct bstr	*bstr;
{
    register long	*options_text_options_set;
    register int	i;
...
static int	csynt_run (language_name)
