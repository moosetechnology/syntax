...
#include "sxunix.h"
char WHAT_TDEFMAIN[] = "@(#)SYNTAX - $Id: tdef_main.c 529 2007-05-09 14:26:33Z rlacroix $" WHAT_DEBUG;
...
long	options_set;
BOOLEAN		sxverbosep, is_source, is_c, is_pascal;
char	*prgentname;
...
static char	*option_tbl [] = {"", "sc", "source", "nsc", "nosource", "v", "verbose", "nv", "noverbose", "c", "pascal"
     , "ln", "language_name",};
static int	option_kind [] = {UNKNOWN_ARG, VERBOSE, VERBOSE, -VERBOSE, -VERBOSE, SOURCE, SOURCE, -SOURCE, -SOURCE, C,
...
static SXVOID	tdef_run (pathname)
