...
static BOOLEAN	grow_items2 (incl, path, items1, nt1, items2, nt2, item2, nt, top, from)
...
static BOOLEAN	grow_items1 (incl, path, items1, nt1, items2, nt2, item2, nt, top)
    register int	*incl, *path, *items1, *items2;
...
static BOOLEAN is_t_trans (item)
    register int	item;
{
...

static BOOLEAN	print_ambiguity (stack1, item, nt_trans)
...
static BOOLEAN check_item (item, S_stack, NT_stack)
    int 		item;
...
static BOOLEAN	read_non_empty (next_state)
    int next_state;
{
