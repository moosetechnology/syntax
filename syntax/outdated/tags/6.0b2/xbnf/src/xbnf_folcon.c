...
#include "B_tables.h"
#include "xbnf_vars.h"
char WHAT_XBNFFOLCON[] = "@(#)SYNTAX - $Id: xbnf_folcon.c 565 2007-05-23 10:05:12Z syntax $" WHAT_DEBUG;
