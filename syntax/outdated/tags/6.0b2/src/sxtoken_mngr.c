...
/************************************************************************/
/* Mer 3 Nov 1999 10:28(pb):	Bug ds sxget_token sur l'ajout des eof	*/
/*				le buffer courant pouvait deborder	*/
/************************************************************************/
...
char WHAT_SXTOKEN_MNGR[] = "@(#)SYNTAX - $Id: sxtoken_mngr.c 527 2007-05-09 14:02:47Z rlacroix $" WHAT_DEBUG;
...

VOID	sxtkn_mngr (sxtkn_mngr_what, size)
    int		sxtkn_mngr_what, size;
{
    int i;
