...
#ifndef VARIANT_32
char WHAT_SXS_SRECOVERY[] = "@(#)SYNTAX - $Id: sxs_srcvr.c 617 2007-06-11 08:24:34Z rlacroix $" WHAT_DEBUG;
#else
char WHAT_SXS_SRECOVERY[] = "@(#)SYNTAX - $Id: sxs_srcvr.c 617 2007-06-11 08:24:34Z rlacroix $ SXS_SRCVR_32" WHAT_DEBUG;
#endif
...
BOOLEAN		sxssrecovery (sxssrecovery_what, state_no, class)
    int		sxssrecovery_what, state_no;
    unsigned char	*class;
{
