...
char WHAT_XCSYNTSINGLE[] = "@(#)SYNTAX - $Id: single.c 613 2007-06-07 13:54:29Z rlacroix $" WHAT_DEBUG;
...

VOID	total_spe (total_spe_single_prod)
...

VOID	partial_spe (partial_spe_single_prod, restriction_set)
    SXBA	partial_spe_single_prod, restriction_set;
{
