...
SCOPE        int inflected_form2display[];
#endif /* def_inflected_form2display */
#if 0

#ifdef def_dico_cmpndcomb_vector
SCOPE        unsigned int dico_cmpndcomb_vector[];
...
SCOPE        unsigned int dico_tcomb_vector[];
...
SCOPE        unsigned int dico_ifcomb_vector[];
...
SCOPE        int args_ref_list[];
#endif /* def_args_ref_list */

#ifdef def_field_id2atom_field_id
SCOPE        int *field_id2atom_field_id[];
