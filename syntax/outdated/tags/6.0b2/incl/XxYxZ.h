...
extern BOOLEAN			XxYxZ_write (/* XxYxZ_header *header_ptr;
						int file; */);
/* Write on "file" the structure "*header_ptr" */

extern BOOLEAN			XxYxZ_read (/* XxYxZ_header *header_ptr;
					       int file; 
					       char *name;
					       int (*user_oflw) ();
					       FILE *stat_file; */);
...
extern void			XxYxZ_to_c (/* XxYxZ_header *header_ptr;
					       FILE *F_X;
					       char *name;
					       BOOLEAN is_static; */);
...
extern void			XxYxZ_array_to_c (/* XxYxZ_header *header_ptr;
						     FILE *F_X;
						     char *name; */);

/* Print on "F_X" the C text for the "arrays" of "header_ptr" */

extern void			XxYxZ_header_to_c (/* XxYxZ_header *header_ptr;
						      FILE *F_X;
						      char *name; */);

/* Print on "F_X" the C text for the "header" of "header_ptr" */

extern void			XxYxZ_reuse (/* XxYxz_header *header_ptr;
						char *name;
						int (*user_oflw)();
						FILE *stat_file; */);
