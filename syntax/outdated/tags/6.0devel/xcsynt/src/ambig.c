...
char WHAT_XCSYNTAMBIG[] = "@(#)SYNTAX - $Id: ambig.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
static SXBOOLEAN		(*includes_F) (SXINT);
...
static SXVOID	oflw_StNt_reads_cycle (SXINT old_size, SXINT new_size)
{
...
static SXVOID	slice_cat (SXINT item1, SXINT item2)
{
...
static SXVOID	outderiv (SXINT xitem, SXINT *items, char *t_string, char **pf)
{
...
SXBOOLEAN is_t_trans_function (SXINT item)
{
...
SXBOOLEAN is_t_in_first (SXINT t, SXINT item)
{
  /* item : A -> alpha . X1 --- Xn */
...
static SXBOOLEAN	SCC (SXINT origine, SXINT X1, SXINT *stack, SXBA check_set)
{
...

static SXVOID	print_ambiguity (SXINT *stack1, SXINT item, SXINT nt_trans)
{
    char	*t_string, *pf;
...
static SXBOOLEAN	includes_traversal (SXINT X)
{
...
static SXVOID NT_closure (SXBA XNT_set, SXINT XNT)
{
    SXINT j, k, NT;
...
static SXBOOLEAN check_item (SXINT item, SXINT *check_item_S_stack, SXINT *check_item_NT_stack)
{
...
static SXVOID print_not_LRpi (SXINT *cycle_stack, SXINT kind)
...
static SXBOOLEAN	read_non_empty (SXINT read_non_empty_next_state)
{
    SXINT 	n, item, kind;
...
static SXBOOLEAN	ambiguity_check (SXINT X1)
{
...

SXBOOLEAN	ambiguity (SXBA conflict_set, SXBA ambig_root_set)
{
    ...
    SXINT	StNt, St;
    SXBOOLEAN		ambiguity_is_ambiguous = SXFALSE;
...
SXBOOLEAN is_ambig_on_StNt (SXINT StNt)
{
    return SXBA_bit_is_set (ambig_StNt_set, StNt);
}

SXVOID	free_ambiguities (void)
{
...
static SXBOOLEAN ambig_orig_F (SXINT X)
{
...
SXVOID	print_ambiguities (/* xac1, */SXBA t_set, SXINT StNt)
{
    /* On sait que:
...

SXBOOLEAN	is_not_nullable (SXINT xnt)
{
...
static SXBOOLEAN cycle_set_to_path (SXINT X)
{
...
SXVOID	print_not_LRpi_conflicts (SXINT kind)
{
