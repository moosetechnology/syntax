...
char WHAT_XCSYNTLR0[] = "@(#)SYNTAX - $Id: LR0.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...

static SXVOID	oflw_nucleus (SXINT old_size, SXINT new_size)
{
...
static SXVOID	oflw_Q0xV (SXINT old_size, SXINT new_size)
{
    sxuse(old_size); /* pour faire taire gcc -Wunused */
...
static SXVOID	mettre (SXINT item)
{
    SXINT	x, tnt;
    SXINT	*q;
...
SXVOID	change_preds (SXINT p, SXINT q1, SXINT q2)
{
...
SXVOID	create_clone (SXINT p, SXINT q1)
{
...
SXBOOLEAN		t_in_deriv (SXINT t, SXINT item)
{
...
SXBOOLEAN ante (SXINT state, SXINT item, SXBOOLEAN (*f)(SXINT, SXINT))
{
