...
#include "out.h"
#include "sxsstmt.h"
char WHAT_TABLESOUTSTBL[] = "@(#)SYNTAX - $Id: out_S_tbl.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
static SXVOID	out_transition (void)
{
  SXINT	j, i, k;
  SXINT	d, nbt;
  SXUINT stmt;
...
static SXVOID	out_S_action_or_prdct_code (void)
{
  SXINT	i;
  SXUINT stmt;
...
static SXVOID	out_S_lregle (void)
{
    SXINT	j, i;
...
static SXVOID	out_S_global_mess (void)
{
    SXINT	i, lg;
    char	*m;
...
static SXVOID	out_S_local_mess (void)
{
    SXINT	j, i, param, lg;
