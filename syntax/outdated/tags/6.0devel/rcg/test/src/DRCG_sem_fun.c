...
#include "dcg_cst.h";
#include "drcg_glbl.h";
char WHAT_RCGTESTDRCG[] = "@(#)SYNTAX - $Id: DRCG_sem_fun.c 1404 2008-06-24 13:05:34Z rlacroix $" WHAT_DEBUG;
    ...
    SXINT prod, nbnt;
{
    ...
    SXINT			lhs_pid;
#if EBUG
    SXBOOLEAN		current_ppp_failed = SXFALSE;
#endif
