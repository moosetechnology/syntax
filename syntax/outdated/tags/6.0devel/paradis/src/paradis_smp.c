...
#include "sem_by.h"
#include "varstr.h"
char WHAT_PARADISSMP[] = "@(#)SYNTAX - $Id: paradis_smp.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
/* On restaure les variables des processeurs utilises par bnf */
	...
	SUCCESS = SXFALSE;
	sxtmsg (sxsrcmngr.source_coord.file_name, "Tables are not generated.", paradis_tables.err_titles [2]);
    }
