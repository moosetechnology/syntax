...
char WHAT_XT_MNGR[] = "@(#)SYNTAX - $Id: XT_mngr.c 2281 2020-03-10 11:24:11Z garavel $" WHAT_DEBUG;
...
XT_stat (FILE *stat_file, XT_header *header)
{
    ...
    fprintf (stat_file, "XT_header: Total_sizeof (byte) = %ld (%ld%%)\n", (unsigned long)total_sizeof, (unsigned long)(100*used_sizeof)/total_sizeof);
}
