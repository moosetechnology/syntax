...
/* sxstr_retrieve() is defined using the GNUC-specific extension ({ ... }) */

#else

SXINT sxstr_save (sxstrmngr_t *strtable, char *string)
{
     char *strvar;

     strvar = string;
     return sxstr_savelen (strtable, strvar, strlen (strvar));
}
...
SXINT sxstr_retrieve (sxstrmngr_t *strtable, char *string)
{
     char *strvar;

     strvar = string;
     return sxstr_retrievelen (strtable, strvar, strlen (strvar));
}
...
SXVOID sxstr_save_keywords (sxstrmngr_t *strtable, char *lang)
{
	...
	sxstr_save (strtable, "bool"); /* not a keyword, strictly speaking */
	...
	sxstr_save (strtable, "false"); /* not a keyword, strictly speaking */
	...
	sxstr_save (strtable, "true"); /* not a keyword, strictly speaking */
    ...
    } else if (strcmp (lang, "LOTOS") == 0) {
        /* reserved "normal" identifiers */
	sxstr_save (strtable, "accept");
	sxstr_save (strtable, "actualizedby");
	sxstr_save (strtable, "any");
	sxstr_save (strtable, "behavior");
	sxstr_save (strtable, "behaviour");
	sxstr_save (strtable, "choice");
	sxstr_save (strtable, "endlib");
	sxstr_save (strtable, "endproc");
	sxstr_save (strtable, "endspec");
	sxstr_save (strtable, "endtype");
	sxstr_save (strtable, "eqns");
	sxstr_save (strtable, "exit");
	sxstr_save (strtable, "for");
	sxstr_save (strtable, "forall");
	sxstr_save (strtable, "formaleqns");
	sxstr_save (strtable, "formalopns");
	sxstr_save (strtable, "formalsorts");
	sxstr_save (strtable, "hide");
	sxstr_save (strtable, "i");
	sxstr_save (strtable, "in");
	sxstr_save (strtable, "is");
	sxstr_save (strtable, "let");
	sxstr_save (strtable, "library");
	sxstr_save (strtable, "noexit");
	sxstr_save (strtable, "of");
	sxstr_save (strtable, "ofsort");
	sxstr_save (strtable, "opnnames");
	sxstr_save (strtable, "opns");
	sxstr_save (strtable, "par");
	sxstr_save (strtable, "process");
	sxstr_save (strtable, "renamedby");
	sxstr_save (strtable, "sortnames");
	sxstr_save (strtable, "sorts");
	sxstr_save (strtable, "specification");
	sxstr_save (strtable, "stop");
	sxstr_save (strtable, "type");
	sxstr_save (strtable, "using");
	sxstr_save (strtable, "where");
	sxstr_save (strtable, "_");
