...
char WHAT_XCSYNTOPTIMLO[] = "@(#)SYNTAX - $Id: optim_lo.c 3502 2023-08-20 19:31:52Z garavel $" WHAT_DEBUG;
...
SXVOID	optim_lo (char *optim_lo_language_name, char *ME)
{
    ...
    fprintf (listing, "\tT_tables:\t%ld\t%ld\t%ld\n", (SXINT) stats.t.i.lines, (SXINT) stats.t.i.cols, (SXINT) (x = stats.t.i.lines * stats.t.i.cols))
	 ;
    fprintf (listing, "\tNT_tables:\t%ld\t%ld\t%ld\n", (SXINT) stats.nt.i.lines, (SXINT) stats.nt.i.cols, (SXINT) (y = stats.nt.i.lines * stats.nt.i.
	 cols));
    put_edit_nl (3);
    ...
    fprintf (listing, "\tT_tables:\t%ld\t%ld\t%ld\t%ld\n", (SXINT) stats.t.r.lines, (SXINT) stats.t.i.cols, (SXINT) i, (SXINT) 100 * (x - i) / x);
    i = stats.nt.r.lines * stats.nt.i.cols;
    fprintf (listing, "\tNT_tables:\t%ld\t%ld\t%ld\t%ld\n", (SXINT) stats.nt.r.lines, (SXINT) stats.nt.i.cols, (SXINT) i, (SXINT) 100 * (y - i) / y);
    put_edit_nl (3);
    ...
    *nt_to_ad = 0 /* nombre de branchements directs */ ;
    ...
    fprintf (listing, "\t\t\t%ld\t%ld\t%ld\t%ld\t\t%ld over %ld\n", (SXINT) stats.nt.c.lines, (SXINT) stats.nt.c.cols, (SXINT) i, (SXINT) 100 * (y - i) / y, (SXINT) *
	 nt_to_ad, (SXINT) bnf_ag.WS_TBL_SIZE.xnbpro);
    put_edit_nl (3);
