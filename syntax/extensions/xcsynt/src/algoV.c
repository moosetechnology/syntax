...
char WHAT_XCSYNTALGOV[] = "@(#)SYNTAX - $Id: algoV.c 3179 2023-05-06 08:32:16Z garavel $" WHAT_DEBUG;
...
static SXBOOLEAN	is_compatible (struct item *avector, 
			       struct item *aitem, 
			       struct item *lim)
{
    SXINT	act, actpi, t;
...
static SXVOID	get_compatibility_with_Vic (struct item *aitem, 
					    struct item *lim, 
					    SXINT *size, 
					    SXINT *def)
{
