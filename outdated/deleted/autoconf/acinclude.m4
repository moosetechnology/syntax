...
# DX_INPUT(LIST)
# --------------
# List of src directory to be included in documentation generated by doxygen
AC_DEFUN([DX_INPUT],	[AC_SUBST([DX_INPUT_LIST], ["$1"])])

# DX_INCLUDE(LIST)
# --------------
# List of incl directory to be included in documentation generated by doxygen
AC_DEFUN([DX_INCLUDE],	[AC_SUBST([DX_INCLUDE_LIST], ["$1"])])
...
DX_ENV_APPEND(DXINPUT, [$DX_INPUT_LIST])
DX_ENV_APPEND(DXINCLUDE, [$DX_INCLUDE_LIST])
