...
char WHAT_RLR_MAIN[] = "@(#)rlr_main.c	- SYNTAX [unix] - 5 mai 1992";
...
static int	option_get_kind (char *arg0)
{
    register char	**opt;
...
char *get_constructor_name (char *string, bool is_lalr, bool is_rlr, SXINT h, SXINT k)
{
    char H [25], K [25];
