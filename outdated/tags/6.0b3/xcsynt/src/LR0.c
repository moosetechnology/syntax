...
char WHAT_XCSYNTLR0[] = "@(#)SYNTAX - $Id: LR0.c 1128 2008-03-04 11:49:22Z rlacroix $" WHAT_DEBUG;
...
BOOLEAN		t_in_deriv (SXINT t, SXINT item)
{
...
BOOLEAN ante (SXINT state, SXINT item, BOOLEAN (*f)(SXINT, SXINT))
{
