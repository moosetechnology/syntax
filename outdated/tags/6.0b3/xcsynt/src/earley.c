...
char WHAT_XCSYNTEARLEY[] = "@(#)SYNTAX - $Id: earley.c 1128 2008-03-04 11:49:22Z rlacroix $" WHAT_DEBUG;
...
extern BOOLEAN	check_real_conformity (SXINT *parse_stack);
extern BOOLEAN	check_level_conformity (SXINT item, SXINT level);
extern BOOLEAN	make_a_quad (SXINT etat_charniere, SXINT item_charniere, SXINT *items_stack);
...
BOOLEAN ttrue (SXINT item, SXINT LA_ref, BOOLEAN is_prefixe)
{
...
static BOOLEAN check_item (SXINT item)
{
...
static BOOLEAN new_EI (SXINT state, SXINT item)
{
...
static BOOLEAN prev_state (SXINT state, SXINT item)
{
...
static BOOLEAN check_bottom (SXINT d)
{
