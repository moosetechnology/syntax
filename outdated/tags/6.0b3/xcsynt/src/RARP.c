...
char WHAT_XCSYNTRARP[] = "@(#)SYNTAX - $Id: RARP.c 1128 2008-03-04 11:49:22Z rlacroix $" WHAT_DEBUG;
...
static BOOLEAN		is_alloc_UARP_called;


static VOID	RARP_open (void)
{
...
static	VOID RARP_next (SXINT RARP_state, SXINT trans)
{
...
static	VOID RARP_sort (SXINT RARP_state)
{
...
static VOID	RARP_construction (void)
{
    SXINT	RARP_state;
