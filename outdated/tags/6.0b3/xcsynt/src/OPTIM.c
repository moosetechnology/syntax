...
char WHAT_XCSYNTOPTIM[] = "@(#)SYNTAX - $Id: OPTIM.c 1128 2008-03-04 11:49:22Z rlacroix $" WHAT_DEBUG;
...
static BOOLEAN	is_0_indistinguable (struct floyd_evans *afei, 
...
static BOOLEAN	is_k_indistinguable (struct floyd_evans *afei, 
				     struct floyd_evans *afej)
{
