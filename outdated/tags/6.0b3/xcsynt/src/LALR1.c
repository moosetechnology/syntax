...
#include "D_tables.h"
#include "bstr.h"
char WHAT_XCSYNTLALR1[] = "@(#)SYNTAX - $Id: LALR1.c 1128 2008-03-04 11:49:22Z rlacroix $" WHAT_DEBUG;
...
extern BOOLEAN	ambiguity (SXBA conflict_set, SXBA ambig_root_set), 
...
extern BOOLEAN	ante (SXINT state, SXINT item, BOOLEAN (*f)(SXINT, SXINT));
extern BOOLEAN	ARC_construction (SXINT *failed_kind, 
                                  SXINT xac1, 
                                  SXBA conflict_t_set, 
...
static SXINT	print_current_conflict, print_next_conflict, next_processed_kind;
...
/* A METTRE DS LR(0) */
static BOOLEAN is_item_in_state (SXINT item, SXINT state)
{
...
static BOOLEAN erase_StNt_StNt1 (SXINT St, SXINT item)
{
    /* Appelee depuis ante */
...
static BOOLEAN	compute_lalr1_conflicts (SXINT xac1)
{
...
static BOOLEAN state_to_conflict_set (SXINT xac1, 
				      BOOLEAN is_u, 
				      BOOLEAN is_s, 
				      SXINT mask, 
...
static VOID set_conflict_kind (SXINT germe_local, SXBA set_conflict_kind_t_set, SXINT failed_kind, BOOLEAN is_ALL)
{
...
BOOLEAN	should_print_conflict (SXINT conflict_kind)
{
...
static BOOLEAN	call_ARC (BOOLEAN is_u, BOOLEAN is_s, SXINT processed_kind)
{
    SXINT	xac1 = 0;
    BOOLEAN	is_RLR = TRUE;
...
static BOOLEAN is_ambig_1 (SXBA StNt_set)
{
