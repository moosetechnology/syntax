...
SX_GLOBAL_VAR_XCSYNT char	*language_name, constructor_name [24];

SX_GLOBAL_VAR_XCSYNT struct bnf_ag_item	bnf_ag;

SX_GLOBAL_VAR_XCSYNT BOOLEAN is_automaton,
...
extern SXINT	LALR1 (void), 
			   ...
			   SXINT Tcard,
			   BOOLEAN dont_reuse_initial_state), 
...
extern VOID	sat_mess (char *name, SXINT no, SXINT old_size, SXINT new_size), 
                ...
                free_not_LRpi (void), 
                ARC_init (BOOLEAN print_conflicts, 
		          SXINT kind, 
...
extern char     *get_constructor_name (char *string,
				       ...
				       SXINT h, 
				       SXINT k);
extern BOOLEAN  should_print_conflict (SXINT conflict_kind), 
                ARC_walk_backward (struct ARC_struct *ARC,
				   SXINT qtq,
				   BOOLEAN (*bh)(struct ARC_struct *, SXINT),
				   BOOLEAN (*bs)(struct ARC_struct *, SXINT)), 
                earley_parse (SXINT LA_init, SXINT LA_final, XH_header *hd, SXINT item, BOOLEAN (*F)(SXINT, SXINT, BOOLEAN)), 
