...
/* Constructeur pour la semantique par actions de SYNTAX */
...
/************************************************************************/
/* 04-12-86 15:56 (phd) :	Initialisation de l'error manager 	*/
/************************************************************************/
/* 25-11-86 18:30 (phd) :	Lecture sur stdin (voir bnf)	 	*/
/************************************************************************/
...
#include <sys/types.h>
#include <sys/stat.h>
char WHAT_SEMACTMAIN[] = "@(#)SYNTAX - $Id: semact_main.c 1209 2008-03-12 15:58:48Z rlacroix $" WHAT_DEBUG;
...
extern BOOLEAN  semact_sem (void);
