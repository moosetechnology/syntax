...
/************************************************************************/
/* 21-01-94 14:19 (pb):		Caractere de "char" a "SXINT"		*/
/************************************************************************/
...
#include <sys/types.h>
#include <sys/stat.h>
char WHAT_PARADISMAIN[] = "@(#)SYNTAX - $Id: paradis_main.c 1209 2008-03-12 15:58:48Z rlacroix $" WHAT_DEBUG;
...
extern BOOLEAN	paradis_sem (void);
