...
static char	ME [] = "drcg";
#endif
char WHAT_DRCGSMP[] = "@(#)SYNTAX - $Id: drcg_smp.c 1127 2008-02-29 13:47:48Z syntax $" WHAT_DEBUG;
...
static void
process_nt (SXINT process_nt_ste, BOOLEAN is_nt)
{
...
static void
gen_ppp (SXINT gen_ppp_ste, SXINT param_nb, NODE *node_ptr)
{
...
drcg_pd2 (void)
{
    ...
    case IS_n :
	gen_ppp (is_ste, (SXINT)2, VISITED->son);
	break;

    case LESS_n :
	gen_ppp (less_ste, (SXINT)2, VISITED->son);
	break;

    case LESS_EQUAL_n :
	gen_ppp (less_equal_ste, (SXINT)2, VISITED->son);
	break;
    ...
    case SUP_n :
	gen_ppp (sup_ste, (SXINT)2, VISITED->son);
	break;

    case SUP_EQUAL_n :
	gen_ppp (sup_equal_ste, (SXINT)2, VISITED->son);
	break;
