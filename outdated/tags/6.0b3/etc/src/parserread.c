...
#include "sxunix.h"
#include "P_tables.h"
char WHAT_PARSERREAD[] = "@(#)SYNTAX - $Id: parserread.c 1215 2008-03-13 14:06:31Z rlacroix $" WHAT_DEBUG;
...
BOOLEAN		parser_read (struct parser_ag_item *parser_ag_ptr, char *langname)
{
    SXINT	bytes, n;
