...
#include "sxunix.h"
#include "S_tables.h"
char WHAT_LECLWRITE[] = "@(#)SYNTAX - $Id: leclwrite.c 1215 2008-03-13 14:06:31Z rlacroix $" WHAT_DEBUG;
...
BOOLEAN		lecl_write (struct lecl_tables_s *lecl_tables_ptr, char *langname)
{
    SXINT	bytes;
    SXINT	i;
    filedesc_t	/* file descriptor */ F_st;
    SXINT		st_version;
    char	ent_name [128];
