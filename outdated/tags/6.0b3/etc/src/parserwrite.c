...
#include "sxunix.h"
#include "P_tables.h"
char WHAT_PARSERWRITE[] = "@(#)SYNTAX - $Id: parserwrite.c 1215 2008-03-13 14:06:31Z rlacroix $" WHAT_DEBUG;
...
BOOLEAN		parser_write (struct parser_ag_item *parser_ag_ptr, char *langname)
{
    /* sortie des tables du parser */
    SXINT	bytes;
    filedesc_t	/* file descriptor */ F_pt;
    SXINT		pt_version;
