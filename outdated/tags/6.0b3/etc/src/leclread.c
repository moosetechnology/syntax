...
#include "sxunix.h"
#include "S_tables.h"
char WHAT_LECLREAD[] = "@(#)SYNTAX - $Id: leclread.c 1215 2008-03-13 14:06:31Z rlacroix $" WHAT_DEBUG;
...
BOOLEAN		lecl_read (struct lecl_tables_s *lecl_tables_ptr, char *langname)
{
    SXINT	bytes;
    SXINT	i;
