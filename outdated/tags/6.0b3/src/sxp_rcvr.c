...
#ifndef VARIANT_32
char WHAT_SXP_RECOVERY[] = "@(#)SYNTAX - $Id: sxp_rcvr.c 1030 2008-02-14 10:05:05Z rlacroix $" WHAT_DEBUG;
#else
char WHAT_SXP_RECOVERY[] = "@(#)SYNTAX - $Id: sxp_rcvr.c 1030 2008-02-14 10:05:05Z rlacroix $ SXP_RCVR_32" WHAT_DEBUG;
#endif
#define Commun 1
#define Propre 2
#define Defaut 3
...
static BOOLEAN	reduce_already_seen (struct SXP_bases *abase, SXP_SHORT check, SXP_SHORT action)
{
...
static BOOLEAN	REF_is_a_right_ctxt (BOOLEAN bscan, 
				     BOOLEAN bshift, 
				     SXINT head, 
				     SXINT tail, 
				     SXINT *pxs, 
...

static BOOLEAN match_a_tok (SXINT cur_mod, SXINT n, SXINT tok)
{
...
static BOOLEAN search_a_rule (SXINT *cur_mod, SXINT n, SXINT best_mod, SXINT *ster)
{
...
static BOOLEAN is_valid (SXINT cur_mod, SXINT n, SXINT *ster)
{
...
static VOID	deriv (BOOLEAN string_has_grown, SXINT n, SXINT xstd, SXP_SHORT t_state, SXINT rule_no);
...

static BOOLEAN	ARC_is_a_correction (SXINT t_state)
...
static BOOLEAN	is_a_correction (BOOLEAN force_correction_on_error_token, SXINT xs, SXP_SHORT state)
...

{
    ...
    if (!force_correction_on_error_token && !is_a_right_ctxt ((SXINT)0, (SXINT)0, &xs2, &state2, FALSE))
    {
...

BOOLEAN		sxprecovery (SXINT what_to_do, SXINT *at_state, SXINT latok_no)
{
    switch (what_to_do) {
    case OPEN:
