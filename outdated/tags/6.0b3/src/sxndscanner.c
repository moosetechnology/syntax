...
#ifndef VARIANT_32
char WHAT_SXNDSCANNER[] = "@(#)SYNTAX - $Id: sxndscanner.c 1037 2008-02-14 13:56:15Z rlacroix $" WHAT_DEBUG;
#else
char WHAT_SXNDSCANNER[] = "@(#)SYNTAX - $Id: sxndscanner.c 1037 2008-02-14 13:56:15Z rlacroix $ SXNDSCANNER_32" WHAT_DEBUG;
#endif
/*
...
VOID ndlv_clear (struct sxndlv *ndlv, BOOLEAN keep_comments)
{
    if (!keep_comments)
