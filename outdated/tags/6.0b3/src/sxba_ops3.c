...
char WHAT_SXBA_OPS3[] = "@(#)SYNTAX - $Id: sxba_ops3.c 807 2007-10-08 14:37:01Z rlacroix $" WHAT_DEBUG;
...
SXBA
sxba_clear (SXBA bits_array, SXINT i, SXINT l)
/*
...
{
  SXBA	from_bits_ptr, to_bits_ptr;
  SXBA_INDEX	        size = sxba_cast (BASIZE (bits_array)), j;
 ...
 */
{
  ...
  SXBA_INDEX  size1 = sxba_cast (BASIZE (bits_array1));
  SXBA_INDEX  size2 = sxba_cast (BASIZE (bits_array2));
  SXBA_INDEX  j;
