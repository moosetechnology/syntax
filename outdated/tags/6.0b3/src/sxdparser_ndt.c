...
char WHAT_SXDPARSER_NDT[] = "@(#)SYNTAX - $Id: sxdparser_ndt.c 1013 2008-02-13 08:37:19Z rlacroix $" WHAT_DEBUG;
...
BOOLEAN sxdparser_ndt (SXINT what_to_do, struct sxtables *arg)
{
    switch (what_to_do) {
    case BEGIN:
