...
#include "sxunix.h"
char WHAT_MAKE_PROPER_MAIN[] = "@(#)SYNTAX - $Id: make_proper_main.c 1189 2008-03-11 12:25:55Z sagot $" WHAT_DEBUG;
...
void   idag_p_t_q2tok_no_stack (SXINT p, SXINT t, SXINT q) {}
