...
#include "lecl_ag.h"
#include "sxdico.h"
char WHAT_LECLGENCHECKKW[] = "@(#)SYNTAX - $Id: gen_check_kw.c 1114 2008-02-27 15:13:51Z rlacroix $" WHAT_DEBUG;
...

static BOOLEAN	by_lgth (SXINT i, SXINT j)
{
...
static SXINT	get_best (SXINT bi, SXINT bf, SXINT kw_lgth, SXINT *min, SXINT *max, BOOLEAN *is_min)
{
