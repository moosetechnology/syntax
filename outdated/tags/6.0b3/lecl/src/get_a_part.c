...
#include "sxunix.h"
char WHAT_LECLGETAPART[] = "@(#)SYNTAX - $Id: get_a_part.c 1114 2008-02-27 15:13:51Z rlacroix $" WHAT_DEBUG;
...

VOID get_a_partition (BOOLEAN (*is_compatible)(SXINT, SXINT, SXINT), 
