...
#include "varstr.h"
#include "lecl_ag.h"
char WHAT_LECLFSA[] = "@(#)SYNTAX - $Id: lecl_fsa.c 1115 2008-02-28 09:03:25Z syntax $" WHAT_DEBUG;
...
/* extern SXINT	sort_by_tree (); 1. c'est un SXVOID et 2. il est maintenant dans sxu2.h */
...

static void	subsuiv (BOOLEAN is_kept, BOOLEAN is_next, BOOLEAN subsuiv_is_first_reduce)
{
...

static BOOLEAN	eq_lr_marker (struct lr_marker *si, struct lr_marker *sj)
{
...
static BOOLEAN	is_state_already_defined (SXINT is_state_already_defined_seed_state, 
					  SXINT else_prdct, 
					  BOOLEAN is_del, 
					  BOOLEAN is_scan, 
					  SXINT *xfsa, 
...

static BOOLEAN	less (SXINT less_i, SXINT less_j)
{
    struct lr_marker	*si, *sj;
...
static	void put_new_trans (SXINT ref, SXINT state_no, BOOLEAN del, BOOLEAN put_new_trans_scan)
{
...
static void	set_new_state (SXINT seed_state_no, 
			       ...
			       SXINT else_prdct_no, 
			       BOOLEAN set_new_state_bdel, 
			       BOOLEAN set_new_state_scan, 
			       char state_kind)
{
...
static BOOLEAN	less_action (SXINT less_action_i, SXINT less_action_j)
{
...

static BOOLEAN	get_del (SXBA get_del_sc_set)
{
...
static BOOLEAN	is_first_reduction (SXINT state_no)
{
...
static BOOLEAN	is_conflict (SXBA sra_set, 
...
static	BOOLEAN conflict_mngr (SXBA sra_set, 
...
static	BOOLEAN conflict_in_comments (SXBA sra_set)
{
...
static	BOOLEAN unbounded_conflict (SXBA sra_set, 
...
static BOOLEAN	is_act_red (SXBA w_set, 
...
/* Si &False => xstate = 0 */
	    ...
	    /* Il n'y a pas de conflit impliquant un predicat:
	       ...
	       "&Else" */
	    predicates_processing (origine, items_no, (BOOLEAN)(current_state_kind & LA));
