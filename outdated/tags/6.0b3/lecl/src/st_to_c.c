...
#include "S_tables.h"
#include "put_edit.h"
char WHAT_LECLSTTOC[] = "@(#)SYNTAX - $Id: st_to_c.c 1114 2008-02-27 15:13:51Z rlacroix $" WHAT_DEBUG;
...
static BOOLEAN	end_of_token (SXINT xprod)
{
    for (;;) {
...
static VOID	goto_state (SXINT state_no, BOOLEAN is_keep, BOOLEAN is_scan)
{
...
static VOID	reduce (SXINT tok, BOOLEAN is_keep, BOOLEAN is_scan, BOOLEAN is_hash, BOOLEAN is_empty, BOOLEAN reduce_is_post_action)
{
...
static	SXVOID gen_label (BOOLEAN is_case, SXBA sc_set)
{
...
static VOID	gen_body (SXINT state_no, BOOLEAN is_empty, transition_matrix_s gen_body_stmt)
{
