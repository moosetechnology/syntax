...
#include "sxunix.h"
#include "put_edit.h"
char WHAT_CXACT[] = "@(#)SYNTAX - $Id: cx_act.c 1174 2008-03-10 12:00:12Z rlacroix $" WHAT_DEBUG;
...
static BOOLEAN	compare_less (SXINT ate1, SXINT ate2)
{
