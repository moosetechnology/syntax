...
#include "varstr.h"
#include <ctype.h>
char WHAT_PPF77MAIN[] = "@(#)SYNTAX - $Id: ppf77_main.c 1209 2008-03-12 15:58:48Z rlacroix $" WHAT_DEBUG;
...
static BOOLEAN	file_copy (char *in, char *out)
{
...
/* initialise: */
	...
	if (stat_buf.st_size != sxppvariables.char_count) {
	    fprintf (stderr, "%s: SEVERE ERROR: Only %ld bytes have been written\non %s (instead of %ld).\n", ME, (long)stat_buf.
