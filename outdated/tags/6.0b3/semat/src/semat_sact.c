...
#include "T_tables.h"
#include "varstr.h"
char WHAT_SEMATSACT[] = "@(#)SYNTAX - $Id: semat_sact.c 1118 2008-02-28 15:53:46Z rlacroix $" WHAT_DEBUG;
...
extern SXINT	genat_pascal (struct T_ag_item *T_ag);
...
extern BOOLEAN		is_check, is_c, is_pascal;
...
static BOOLEAN	compare_node_name (SXINT i, SXINT j)
{
...
static BOOLEAN	is_post (SXINT nt, char *post)
{
    SXINT	l, lpost;
    char	*s;
