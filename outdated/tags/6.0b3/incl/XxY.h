...
extern BOOLEAN			XxY_set (XxY_header *header, 
					 SXINT X, 
					 SXINT Y, 
					 SXINT *ref);
...
extern BOOLEAN			XxY_write (XxY_header *header, filedesc_t F_XxY /* file descriptor */);
/* Write on "file" the structure "*header" */

extern BOOLEAN			XxY_read (XxY_header *header, 
					  filedesc_t F_XxY /* file descriptor */, 
					  char *name, 
					  void (*user_oflw) (SXINT, SXINT), 
					  FILE *stat_file);
...
extern BOOLEAN			XxY_set_and_close (XxY_header *header, 
						   SXINT X, 
						   SXINT Y, 
						   SXINT *ref);
...
extern void			XxY_to_SXBM (XxY_header *header, 
					     BOOLEAN (*get_couple) (SXINT*, SXINT*, SXINT), 
					     SXINT couple_nb, 
					     X_header *index_hd, 
					     SXBA **M);
