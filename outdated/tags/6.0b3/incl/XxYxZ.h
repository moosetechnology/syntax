...
extern BOOLEAN			XxYxZ_set (XxYxZ_header *header, 
					   SXINT X, 
					   SXINT Y, 
					   SXINT Z, 
					   SXINT *ref);
...
extern BOOLEAN			XxYxZ_write (XxYxZ_header *header, 
					     filedesc_t F_XxYxZ /* file descriptor */);
/* Write on "file" the structure "*header" */

extern BOOLEAN			XxYxZ_read (XxYxZ_header *header, 
					    filedesc_t F_XxYxZ /* file descriptor */, 
					    char *name, 
					    void (*user_oflw) (SXINT, SXINT), 
					    FILE *stat_file);
