...
#include "xbnf_vars.h"
#include "varstr.h"
char WHAT_XBNFSYMTAB[] = "@(#)SYNTAX - $Id: xbnf_symtab.c 1122 2008-02-28 15:55:03Z rlacroix $" WHAT_DEBUG;
...
static SXINT	st_get_t_code (struct sxsource_coord source_index, SXINT ste, BOOLEAN is_gene)
{
    SXINT	t;
    BOOLEAN		is_old_gene;
