...
#ifndef sxindex
# define sxindex	strchr	/* preferably to index */
#endif

#ifndef sxrindex
# define sxrindex	strrchr	/* preferably to rindex */ 
#endif
...
extern unsigned int sxstr2save ();
...
extern VOID sxppp (int what, struct sxtables *);
