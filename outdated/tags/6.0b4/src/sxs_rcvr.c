...
#ifndef VARIANT_32
char WHAT_SXS_RECOVERY[] = "@(#)SYNTAX - $Id: sxs_rcvr.c 1039 2008-02-15 08:39:57Z rlacroix $" WHAT_DEBUG;
#else
char WHAT_SXS_RECOVERY[] = "@(#)SYNTAX - $Id: sxs_rcvr.c 1039 2008-02-15 08:39:57Z rlacroix $ SXS_RCVR_32" WHAT_DEBUG;
#endif
...
static BOOLEAN	is_insertable (SXINT class_no, SXINT *rank)
{
...
static BOOLEAN	check (SXINT state_no, SXINT class_of_X, SXINT *model, BOOLEAN is_la)
{
...
static BOOLEAN	is_valid (SXINT state_no, struct SXS_correction_item *current, BOOLEAN *is_validated, BOOLEAN is_la)
{
...
static VOID	tryacorr (SXINT state_no, BOOLEAN is_la, struct SXS_correction_item *best)
{
...
BOOLEAN		sxsrecovery (SXINT sxsrecovery_what, SXINT state_no, unsigned char *class)
{
