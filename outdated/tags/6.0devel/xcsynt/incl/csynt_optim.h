...
SX_GLOBAL_VAR_XCSYNT SXBOOLEAN is_automaton,
...
extern SXVOID	sat_mess (char *name, SXINT no, SXINT old_size, SXINT new_size), 
                ...
                free_not_LRpi (void), 
                ARC_init (SXBOOLEAN print_conflicts, 
		          SXINT kind, 
...
extern char     *get_constructor_name (char *string,
				       ...
				       SXINT h, 
				       SXINT k);
extern SXBOOLEAN  should_print_conflict (SXINT conflict_kind), 
                ARC_walk_backward (struct ARC_struct *ARC,
				   SXINT qtq,
				   SXBOOLEAN (*bh)(struct ARC_struct *, SXINT),
				   SXBOOLEAN (*bs)(struct ARC_struct *, SXINT)), 
                earley_parse (SXINT LA_init, SXINT LA_final, XH_header *hd, SXINT item, SXBOOLEAN (*F)(SXINT, SXINT, SXBOOLEAN)), 
