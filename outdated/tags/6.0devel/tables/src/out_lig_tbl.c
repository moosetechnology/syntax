...
#include "out.h"
#include "lig.h"
char WHAT_TABLESOUTLIGTBL[] = "@(#)SYNTAX - $Id: out_lig_tbl.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
static SXBOOLEAN lig_read (char *lig_read_prgentname)
{
#define READ(f,p,l)						\
...
static SXBOOLEAN check_couple (SXINT prdct1, SXINT prdct2)
{
...
SXBOOLEAN out_lig_tables (char *ln)
{
    SXINT		i, j, prdct, x, y;
    SXBOOLEAN	ret_val;
