...
#include "tables.h"
#include "sem_by.h"
char WHAT_TABLESINITTBL[] = "@(#)SYNTAX - $Id: init_tbl.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
/* vérification de la date des fichiers */
	...
	fprintf (sxstderr, bad_followers_message, ME, (long)RC.P_followers_number, (long)5);
