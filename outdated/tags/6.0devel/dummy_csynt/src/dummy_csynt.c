...
#include "B_tables.h"
#include "P_tables.h"
char WHAT_DUMMYCSYNT[] = "@(#)SYNTAX - $Id: dummy_csynt.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
int main (int argc, char *argv[])
{
 ...
 run:
  ...
  do {
    has_message [dummy_csynt_run (argv [argnum++])] = SXTRUE;
  } while (argnum < argc);
