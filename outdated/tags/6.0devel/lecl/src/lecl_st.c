...
char WHAT_LECLST[] = "@(#)SYNTAX - $Id: lecl_st.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
complete_st:
   ...
   lexical */
		...
		sxtmsg (sxsrcmngr.source_coord.file_name, "A description of %s must be given.", err_titles [2]
			/* error */
														,
		     sxstrget (t_to_ate [i]));
	    }
