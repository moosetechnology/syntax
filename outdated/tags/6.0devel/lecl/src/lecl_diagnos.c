...
#include "varstr.h"
#include "lecl_ag.h"
char WHAT_LECLDIAGNOS[] = "@(#)SYNTAX - $Id: lecl_diagnos.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
static SXVOID given_priority (VARSTR varstr_ptr, SXINT choice)
{
    ...
    sxtmsg (sxsrcmngr.source_coord.file_name, "%s.", err_titles [1], varstr_tostr (varstr_ptr));
}
