...
char WHAT_LECLSMP[] = "@(#)SYNTAX - $Id: lecl_smp.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
no_automaton:
    sxtmsg (sxsrcmngr.source_coord.file_name, "Construction failed : the finite state automaton is not generated.",
	 err_titles [2]);
