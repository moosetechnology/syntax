...
#include "varstr.h"
#include "lecl_ag.h"
char WHAT_LECLFSA[] = "@(#)SYNTAX - $Id: lecl_fsa.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
/* on a des predicats differents non disjoints, il y a conflit si leur 
   next_state sont differents */
		    ...
		    if (is_conflict) {
			sxtmsg (sxsrcmngr.source_coord.file_name, "The following predicates are not disjoint :\n\r%s%s"
