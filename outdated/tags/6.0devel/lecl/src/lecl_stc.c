...
#include "lecl_ag.h"
#include "lecl_pcn.h"
char WHAT_LECLSTC[] = "@(#)SYNTAX - $Id: lecl_stc.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
				      ...
				      SXBOOLEAN is_an_abbrev)
{
   ...
   code interne */
	    ...
	    printf ("CED (predicate_processing): action_or_prdct_to_ate [-%ld <= %ld <= %ld] =%s\n", (long)action_size,
		 (long)xprdct_to_ate, (long)predicate_size, sxstrget (ate));
