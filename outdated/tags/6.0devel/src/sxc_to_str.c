...
char WHAT_SXC_TO_STR[] = "@(#)SYNTAX - $Id: sxc_to_str.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
 ...
 *  en
 *     ABCDEFGHIJKLMNOPQRSTUVWXYZ
 * (tous les autres caracteres restant inchangesß)
 **/
 ...
 *     ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏ ÐÑÒÓÔÕÖ ØÙÚÛÜÝÞß
 *  en
 *     AAAAAAACEEEEIIII DNOOOOO OUUUUYÞß
 *  et
 *     àáâãäåæçèéêëìíîï ðñòóôõö øùúûüýþÿ
 *  en
 *     aaaaaaaceeeeiiii dnooooo ouuuuyþy
 * (tous les autres caracteres restant inchanges)
 **/
