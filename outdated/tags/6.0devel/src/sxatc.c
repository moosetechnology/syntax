...
char WHAT_SXATC[] = "@(#)SYNTAX - $Id: sxatc.c 2323 2020-08-25 15:13:37Z garavel $" WHAT_DEBUG;
...
static SXVOID	freeareas (void)
{
    ...
    sxatcvar.atc_lv.abstract_tree_root = NULL; // (Damien et Benoit) valgrind dit que l'on ecrit dans une zone liberee ligne 369, il faudrait mettre sxatcvar.atc_lv.abstract_tree_root a NULL ?
}
