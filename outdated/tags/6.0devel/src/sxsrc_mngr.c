...
#ifdef sxgetchar_is_redefined
/* on a donc demandé une compilation spéciale de sxsrc_mngr.c avec -Dsxgetchar, car on veut se le
...
char WHAT_SXSRC_MNGR[] = "@(#)SYNTAX - $Id: sxsrc_mngr.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
 ...
 * et 0321 de VASY). Il peut aussi etre reproduit sur l'exemple Petit_Langage
 ...
 * modifier tous les compilateurs eux-memes, ou bien (2) d�sactiver la 
