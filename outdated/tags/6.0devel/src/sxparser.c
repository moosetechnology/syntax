...
#include "sxunix.h"
#ifndef VARIANT_32
char WHAT_SXPARSER[] = "@(#)SYNTAX - $Id: sxparser.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
#else
char WHAT_SXPARSER32[] = "@(#)SYNTAX - $Id: sxparser.c 2227 2018-09-26 16:22:59Z garavel $ SXPARSER_32" WHAT_DEBUG;
#endif
...
/* Swap de s1 et s2 : premiere etiquette apres scan
   Evaluation de s1 : premier test explicite */
	...
	if ((state = ref - sxplocals.SXP_tables.Mprdct) > 0 /* Shift */ ) {
		...
		sxplocals.state = (SXINT) ((sxplocals.ptok_no == sxplocals.atok_no) ? labs ((long)s2->state) : s1->state);
