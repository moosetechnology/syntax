...
char WHAT_SXND2PARSER[] = "@(#)SYNTAX - $Id: sxnd2parser.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
static SXBOOLEAN sxnddesambig_it ()
{
    ...
    fprintf (sxtty, "Source text: %ld tokens, %ld shift-transitions, %ld reduce-steps.\n",
	     (long)sxplocals.Mtok_no - 1, (long)parse_stack.shift_trans_nb, (long)parse_stack.red_trans_nb);
#endif    
