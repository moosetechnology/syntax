...
char WHAT_SXFILECOPY[] = "@(#)SYNTAX - $Id: sxfilecopy.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
SXBOOLEAN	sxfile_copy (char *in, char *out, long char_count, char *ME)
{
    SXINT	nbread;
    long	cumul;
