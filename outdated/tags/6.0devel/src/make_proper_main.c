...
#include "sxversion.h"
#include "sxunix.h"
char WHAT_MAKE_PROPER_MAIN[] = "@(#)SYNTAX - $Id: make_proper_main.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
*   *****************************************************************************************\n\n\n",
	...
	fputs ("\n", stdout);
      ...
      sxtmsg (sxsvar.sxlv.terminal_token.source_index.file_name,
	      "No proper sub-grammar for the language \"%s\" can be constructed from the input terminal sub-set.",
