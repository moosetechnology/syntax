...
char WHAT_SXSPELL_MNGR[] = "@(#)SYNTAX - $Id: sxspell_mngr.c 2312 2020-03-24 16:37:13Z garavel $" WHAT_DEBUG;
...
FSA_walk (SXINT p, SXINT q)
{
  ...
  if (is_suffix) {
	...
	char_stack_ptr = dico_base2char_stack_ptr (cur_dico, base); // BS: ne marche pas si on n'a pas donné -comb 2 à make_a_dico pour construire cur_dico
