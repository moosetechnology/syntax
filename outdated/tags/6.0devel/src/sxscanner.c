...
#ifdef sxgetchar_is_redefined
/* on a donc demandé une compilation spéciale de sxscanner.c avec -Dsxgetchar, car on veut se le
   redéfinir différement de la macro définie dans sxu2.h */
/* sécurité */
#undef sxgetchar
...
#ifndef VARIANT_32
char WHAT_SXSCANNER[] = "@(#)SYNTAX - $Id: sxscanner.c 2240 2018-10-25 09:47:19Z garavel $" WHAT_DEBUG;
#else
char WHAT_SXSCANNER32[] = "@(#)SYNTAX - $Id: sxscanner.c 2240 2018-10-25 09:47:19Z garavel $ SXSCANNER_32" WHAT_DEBUG;
#endif
...
# if BUG
    ...
    printf ("\t\t\tstring = \"%s\"\n",
	    sxsvar.sxlv.terminal_token.string_table_entry == SXEMPTY_STE ? "" : sxstrget (sxsvar.sxlv.terminal_token.string_table_entry));
