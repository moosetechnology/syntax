...
char WHAT_LC1[] = "@(#)SYNTAX - $Id: LC1.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
output_elc_tables (void)
{
  ...
  SXBOOLEAN       has_t_trans = SXFALSE, has_nt_trans = SXFALSE, has_tequiv = SXFALSE, has_ntequiv = SXFALSE, has_eps_red = SXFALSE;
  ...
  out_define ("is_epsilon", (long)is_epsilon);
  ...
  for (prod = 0; prod < limpro; prod++) {
    ...
    printf ("/* %ld [%ld..%ld] */\t", (long)prod, (long)item, (long)prolon [prod+1]-1);
  ...
  for (state = 1; state <= max_state; state++) {
    printf ("/* %ld */\t%ld,\n", (long)state, (long)state2item [state]);
  }
  ...
  if (has_tequiv) {
    ...
    for (state = 1; state <= max_state; state++) {
      printf ("/* %ld */\t%ld,\n", (long)state, (long)state2tstate [state]);
    }
  ...
  if (has_ntequiv) {
    ...
    for (state = 1; state <= max_state; state++) {
      printf ("/* %ld */\t%ld,\n", (long)state, (long)state2ntstate [state]);
    }
  ...
  vector2c (&t_vector, stdout, "t_shift", SXTRUE /* static */);
  ...
  vector2c (&knt_vector, stdout, "knt_shift", SXTRUE /* static */);
  ...
  vector2c (&nknt_vector, stdout, "nknt_shift", SXTRUE /* static */);
  ...
  for (x = 1; x < top; x++) {
    ...
    do {
      printf ("%ld, ", (long)XH_list_elem (nd_trans, bot2));
      cur++;
    } while (++bot2 < top2);
  ...
  if (is_epsilon) {
	...
	do {
	  printf ("%ld, ", (long)XH_list_elem (eps_reds, bot2));
	  cur++;
	} while (++bot2 < top2);
    ...
    for (state = 1; state <= max_state; state++) {
      printf ("/* %ld */ %ld,\n", (long)state, (long)eps_red_disp [state]);
    }
  ...
  puts ("\n#if is_1LA");
  sxbm3_to_c (stdout, prod2la_set, limpro, "prod2la_set", "", SXTRUE /* is_static */);
  puts ("#endif /* is_1LA */");
...
SXVOID output_segments (void)
{
  ...
  out_ifdef ("segment");
  printf ("static SXINT segment [%ld] = {\n", (long)bnf_ag.WS_TBL_SIZE.indpro+1);
  for (prod = 0; prod <= bnf_ag.WS_TBL_SIZE.nbpro; prod++) {
    printf ("/* prod=%ld */", (long)prod);
    ...
    while (bnf_huge_item_2 == 0 || bnf_ag.WS_INDPRO [bnf_huge_item_2].lispro != 0) {
      printf (" %ld,", (long)segment [bnf_huge_item_2]);
      bnf_huge_item_2++;
    }
...
output_tables (void)
{
    ...
    sxbm3_to_c (stdout, nt2gen_t_set, limnt, "nt2gen_t_set", "", SXTRUE /* is_static */);
    ...
    for (nt = 1; nt < limnt; nt++) {
	printf ("/* %ld = %s */\t%ld,\n", (long)nt, get_nt_string (nt), (long)nt2order [nt]);
    }
    ...
    for (nt = 1; nt < limnt; nt++) {
	printf ("/* %ld */\t%ld /* %s */,\n", (long)nt, (long)order2nt [nt], get_nt_string (nt));
    }
    ...
    printf ("/* %ld */\t%ld /* %s */,\n", (long)0, (long)rhs_nt2where [0], "terminals");

    for (nt = 1; nt < limnt; nt++) {
	printf ("/* %ld */\t%ld /* %s */,\n", (long)nt, (long)rhs_nt2where [nt], get_nt_string (nt));
    }
    ...
    printf ("/* %ld */\t%ld /* %s */,\n", (long)0, (long)lhs_nt2where [0], "<Super Start Symbol>");

    for (nt = 1; nt < limnt; nt++) {
	printf ("/* %ld */\t%ld /* %s */,\n", (long)nt, (long)lhs_nt2where [nt], get_nt_string (nt));
    }
    ...
    sxbm3_to_c (stdout, t2item_set, limt, "t2item_set", "", SXTRUE /* is_static */);
    out_endif ("t2item_set");

    out_ifdef ("left_corner");
    sxbm3_to_c (stdout, left_corner, limnt, "left_corner", "", SXTRUE /* is_static */);
    out_endif ("left_corner");

    out_ifdef ("nt2item_set");
    sxbm3_to_c (stdout, nt2item_set, limnt, "nt2item_set", "", SXTRUE /* is_static */);
    ...
    if (bnf_ag.RULE_TO_REDUCE != NULL) {
      ...
      for (prod = 1; prod < limpro; prod++) {
	printf ("/* %ld */\t%ld,\n", (long)prod, (long)bnf_ag.RULE_TO_REDUCE [prod]);
      }
    ...
    if (is_epsilon) {
      out_ifdef ("BVIDE");
      sxba2c (bvide, stdout, "BVIDE", "", SXTRUE /* is_static */, output_tables_vstr);
      out_endif ("BVIDE");
    }

#if 0
    sxba2c (bnf_ag.NULLABLE, stdout, "NULLABLE", "", SXTRUE /* is_static */, output_tables_vstr);
#endif
    ...
    for (prod = 0; prod < limpro; prod++) {
	printf ("/* %ld */\t%ld,\n", (long)prod, (long)prod2order [prod]);
    }
    ...
    for (prod = 0; prod < limpro; prod++) {
	printf ("/* %ld */\t%ld,\n", (long)prod, (long)order2prod [prod]);
    }
    ...
    if (rrnt > 0) {
      ...
      for (prod = 0; prod < limpro; prod++) {
	printf ("/* %ld */\t%ld,\n", (long)prod, (long)prod_order2min [prod]);
      }
      ...
      for (prod = 0; prod < limpro; prod++) {
	printf ("/* %ld */\t%ld,\n", (long)prod, (long)prod_order2max [prod]);
      }
      ...
      sxba2c (is_mutual_right_recursive_prod, stdout, "is_right_recursive_prod", "",
	      SXTRUE		/* is_static */, output_tables_vstr);
#endif

      if (ccnt > 0) {
#if 0
	sxbm2c (stdout, cycle_nb2item_set, ccnt+1, "cycle_nb2item_set", "", SXTRUE /* is_static */, output_tables_vstr);
#endif
	...
	for (prod = 0; prod < limpro; prod++) {
	  ...
	  while ((X = lispro [item]) != 0) {
	    printf ("%ld, ", (long)item2cycle_nb [item]);
	    item++;
	  }

	  printf ("%ld,\n", (long)item2cycle_nb [item]);
	}
	...
	if (multiple_t) {
      ...
      sxbm2c (stdout, t2prod_item_set, limt, "t2prod_item_set", "", SXTRUE /* is_static */, output_tables_vstr);
	...
	puts ("#define multiple_t_item_set_is_not_empty\n");
	sxba2c (multiple_t_item_set, stdout, "multiple_t_item_set", "", SXTRUE /* is_static */, output_tables_vstr);
      }
	...
	out_ifdef ("titem_set");
	sxba2c (titem_set, stdout, "titem_set", "", SXTRUE /* is_static */, output_tables_vstr);
	out_endif ("titem_set");
...

	{
	  ...
	  out_ifdef ("nt2t_set");
	  sxbm2c (stdout, nt2t_set, limnt, "nt2t_set", "", SXTRUE /* is_static */, output_tables_vstr);
	  out_endif ("nt2t_set");
	...
	sxba2c (rc_titem_set, stdout, "rc_titem_set", "", SXTRUE /* is_static */, output_tables_vstr);
	...
	sxbm2_to_c (stdout, nt2item_set, limnt, "nt2lc_item_set", "", SXTRUE /* is_static */);
	out_endif ("nt2lc_item_set");


	out_ifdef ("nt2rc_item_set");
	sxbm2_to_c (stdout, nt2rc_item_set, limnt, "nt2rc_item_set", "", SXTRUE /* is_static */);
	...
	sxba2c (valid_suffixes, stdout, "valid_suffixes", "", SXTRUE /* is_static */, output_tables_vstr);
	out_endif ("valid_suffixes");

	out_ifdef ("valid_prefixes");
	sxba2c (valid_prefixes, stdout, "valid_prefixes", "", SXTRUE /* is_static */, output_tables_vstr);
	out_endif ("valid_prefixes");

	out_ifdef ("suffix_titem_set");
	sxba2c (init_titem_set, stdout, "suffix_titem_set", "", SXTRUE /* is_static */, output_tables_vstr);
	out_endif ("suffix_titem_set");

	out_ifdef ("prefix_titem_set");
	sxba2c (prefix_titem_set, stdout, "prefix_titem_set", "", SXTRUE /* is_static */, output_tables_vstr);
...

	{
	  ...
	  for (output_tables_X_3 = 1; output_tables_X_3 <= limnt; output_tables_X_3++) {
	    printf ("/* %ld */ %ld,\n", (long)output_tables_X_3, (long)bnf_ag.WS_NTMAX [output_tables_X_3].npg);
	  }
	  ...
	  for (output_tables_X_3 = 1; output_tables_X_3 < limnt; output_tables_X_3++) {
	    printf ("/* %ld */ ", (long)output_tables_X_3);
	    ...
	    for (lim = bnf_ag.WS_NTMAX [output_tables_X_3 + 1].npg, output_tables_i = bnf_ag.WS_NTMAX [output_tables_X_3].npg; output_tables_i < lim; output_tables_i++) {
	      printf ("%ld, ", (long)bnf_ag.WS_NBPRO [output_tables_i].numpg);
	    }
	  ...
	  if (is_epsilon) {
	    ...
	    sxba2c (is_fully_empty, stdout, "is_fully_empty", "", SXTRUE /* is_static */, output_tables_vstr);
	  ...
	  for (output_tables_X_3 = 1; output_tables_X_3 < limnt; output_tables_X_3++) {
	    ...
	    for (lim = bnf_ag.WS_NTMAX [output_tables_X_3 + 1].npd, output_tables_i = bnf_ag.WS_NTMAX [output_tables_X_3].npd; output_tables_i < lim; output_tables_i++) {
	      printf ("%ld, ", (long)bnf_ag.NUMPD [output_tables_i]);
	    }
	  ...
	  for (output_tables_X_3 = 1; output_tables_X_3 < limnt; output_tables_X_3++) {
	    printf ("/* %ld */ %ld,\n", (long)output_tables_X_3, (long)npd [0]);
	...
	if (is_epsilon) {
	  ...
	  sxba2c (empty_prod_item_set, stdout, "empty_prod_item_set", "", SXTRUE /* is_static */, output_tables_vstr);
    ...
    if (is_PLR) {
	puts ("\n#if is_PLR");
	out_define ("q0", (long)q0);
	out_define ("q2", (long)q2);
	out_define ("q3", (long)q3);
	out_define ("qmax", (long)qf);

	puts ("\n\nstatic SXINT q2prod [] = {");

	for (q = q0; q <= qf; q++) {
	    printf ("/* %ld */\t%ld,\n", (long)q, (long)q2prod [q]);
	}

	puts ("};");

	sxbm2c (stdout, kq2q_set, qf+1, "kq2q_set", "", SXTRUE /* is_static */, output_tables_vstr);

	sxbm2c (stdout, nkq2q_set, qf+1, "nkq2q_set", "", SXTRUE /* is_static */, output_tables_vstr);

	sxbm2c (stdout, int2q_set, limt, "int2q_set", "", SXTRUE /* is_static */, output_tables_vstr);

	sxbm2c (stdout, innt2q_set, limnt, "innt2q_set", "", SXTRUE /* is_static */, output_tables_vstr);

	sxbm2c (stdout, outt2q_set, limt, "outt2q_set", "", SXTRUE /* is_static */, output_tables_vstr);

	sxbm2c (stdout, outnt2q_set, limnt, "outnt2q_set", "", SXTRUE /* is_static */, output_tables_vstr);

	sxba2c (Q_is_shift, stdout, "Q_is_shift", "", SXTRUE /* is_static */, output_tables_vstr);

	puts ("\n\nstatic SXINT delta [] = {");

	for (x = 0; x <= xdelta; x++) {
	    printf ("%ld, ", (long)delta [x]);
...
SXBOOLEAN		open_listing (SXINT kind, char *open_listing_language_name, char *open_listing_ME, char *component_name)
{
    struct bstr	*bstr;
...
xt_to_str (SXINT code)
{
	...
	if (xt_to_str_prdct >= 0) {
	    sprintf (small_string, " &%ld", (long)xt_to_str_prdct);
...
xnt_to_str (SXINT code)
{
	...
	if (xtn_to_str_prdct >= 0) {
	    sprintf (small_string, " &%ld", (long)xtn_to_str_prdct);
	    varstr_catenate (wvstr, small_string);
	}
...

{
	...
	if (rrnt > 0) {
		...
		sprintf (str, " [i = %ld, min_i = %ld, max_i = %ld]", (long)i, (long)prod_order2min [i], (long)prod_order2max [i]);
	...
	if (is_PLR) {
		...
		while ((item = sxba_scan (Q2item_set [q], item)) >= 0) {
			...
			if (lispro [item] == 0) {
			    ...
			    sprintf (s1, " ---> %ld", (long)item2Q [item+1]);
...
LC1 (void)
{
    ...
    */
    ...
    {
        extern SXBOOLEAN	parser_write (struct parser_ag_item *parser_ag_ptr, char *langname);
