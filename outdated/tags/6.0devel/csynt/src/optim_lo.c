...
#include "bstr.h"
char WHAT_OPTIMLO[] = "@(#)SYNTAX - $Id: optim_lo.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
SXBOOLEAN		open_listing (SXINT kind, char *ln, char *ME, char *component_name)
{
    struct bstr	*bstr;
#include <time.h>
...
SXVOID	output_fe (SXINT kind, SXINT xa, SXINT test, struct floyd_evans *afe)
{
    SXINT		i;
...
SXVOID	optim_lo (char *ln, char *ME)
{
    static char		hyph60 [] = "-------------------------------------------------------------";
    static char		dot46 [] = ".............................................";
    SXINT	i, x, y, l;
    ...
    fprintf (listing, "\tT_tables:\t%ld\t%ld\t%ld\n", (long)stats.t.i.lines, (long)stats.t.i.cols,
	     (long)(x = stats.t.i.lines * stats.t.i.cols));
    fprintf (listing, "\tNT_tables:\t%ld\t%ld\t%ld\n", (long)stats.nt.i.lines, (long)stats.nt.i.cols,
	     (long)(y = stats.nt.i.lines * stats.nt.i.cols));
    put_edit_nl (3);
    put_edit (21, "F S A   R E D U C T I O N");
    put_edit_nl (1);
    fprintf (listing, "\t\t\tlines\tcolumns\tcells\tgain (%%)\n");
    i = stats.t.r.lines * stats.t.i.cols;
    fprintf (listing, "\tT_tables:\t%ld\t%ld\t%ld\t%ld\n", (long)stats.t.r.lines, (long)stats.t.i.cols,
	     (long)i, (long)100 * (x - i) / x);
    i = stats.nt.r.lines * stats.nt.i.cols;
    fprintf (listing, "\tNT_tables:\t%ld\t%ld\t%ld\t%ld\n", (long)stats.nt.r.lines, (long)stats.nt.i.cols,
	     (long)i, (long)100 * (y - i) / y);
    put_edit_nl (3);
    ...
    *nt_to_ad = 0 /* nombre de branchements directs */ ;
    ...
    fprintf (listing, "\t\t\t%ld\t%ld\t%ld\t%ld\t\t%ld over %ld\n", (long)stats.nt.c.lines, (long)stats.nt.c.cols,
	     (long)i, (long)100 * (y - i) / y, (long)*nt_to_ad, bnf_ag.WS_TBL_SIZE.xnbpro);
    put_edit_nl (3);
