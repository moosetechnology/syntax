...
#include "sxunix.h"
#include "B_tables.h"
char WHAT_TABC[] = "@(#)SYNTAX - $Id: tabc.c 2227 2018-09-26 16:22:59Z garavel $" WHAT_DEBUG;
...
extern SXVOID	put_release (char *);
...
static SXVOID	tabc_lo_init (void)
{
    char	lst_name [32];
