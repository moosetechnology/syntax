...
SXLOGPROB lex_id2logprobs [1] /* empty */;
...
SXLOGPROB full_ctxtXeprod2logprobs [1] /* empty */;
XxY_header eprod_ctxtXeprod_hd;
SXLOGPROB eprod_ctxtXeprod2logprobs [1] /* empty */;
XxY_header prod_ctxtXeprod_hd;
SXLOGPROB prod_ctxtXeprod2logprobs [1] /* empty */;
XxY_header A_ctxtXeprod_hd;
SXLOGPROB A_ctxtXeprod2logprobs [1] /* empty */;
SXLOGPROB eprod2logprobs [1] /* empty */;
XxY_header full_ctxtXlex_id_hd;
SXLOGPROB full_ctxtXlex_id2logprobs [1] /* empty */;
XxY_header eprod_ctxtXlex_id_hd;
SXLOGPROB eprod_ctxtXlex_id2logprobs [1] /* empty */;
XxY_header prod_ctxtXlex_id_hd;
SXLOGPROB prod_ctxtXlex_id2logprobs [1] /* empty */;
XxY_header A_ctxtXlex_id_hd;
SXLOGPROB A_ctxtXlex_id2logprobs [1] /* empty */;
XxY_header ff_idXt2lex_id_hd;

/* Function to be used for checking consistency between the definition of SXFLOAT 
...
SXINT
get_prod2logprobs_type (void) {
  return SXFLOAT_TYPE_ID;
}

/* PCFG (log)probas */
SXLOGPROB prod2logprobs [PROD_NB+1] = {0,
#ifdef SXLOGPROB_IS_SXFLOAT
END

for $pid (1..$#pid2logprob) {
  print "/* $pid: $pid2prod[$pid] $pid2prob[$pid] */ $pid2logprob[$pid],\n";
}
print <<END;
...
for $pid (1..$#pid2logprob) {
  print "/* $pid: $pid2prod[$pid] $pid2prob[$pid] */ (SXLOGPROB)(SXLOGPROB_FACTOR*($pid2logprob[$pid])),\n";
}
print <<END;
