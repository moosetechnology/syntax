...
#include "bstr.h"
char WHAT_OPTIMLO[] = "@(#)SYNTAX - $Id: optim_lo.c 605 2007-05-31 13:18:23Z rlacroix $" WHAT_DEBUG;
...
BOOLEAN		open_listing (kind, language_name, ME, component_name)
    int		kind;
    ...
    char	*language_name, *ME;
{
    ...
    *nt_to_ad = 0 /* nombre de branchements directs */ ;
    ...
    fprintf (listing, "\t\t\t%d\t%d\t%d\t%d\t\t%d over %d\n", stats.nt.c.lines, stats.nt.c.cols,
	     i, 100 * (y - i) / y, *nt_to_ad, bnf_ag.WS_TBL_SIZE.xnbpro);
    put_edit_nl (3);
