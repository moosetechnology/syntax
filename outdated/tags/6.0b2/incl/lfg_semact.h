...
SX_GLOBAL_VAR BOOLEAN           is_print_f_structure;
SX_GLOBAL_VAR BOOLEAN           is_partial  /* TRUE <=> Aucune f_structure a la racine, on a recupere ce qu'on a pu ... */;
SX_GLOBAL_VAR BOOLEAN           is_relaxed_run /* positionne si le 1er passage a echoue'.  On en refait un sans la verif de la coherence */;
SX_GLOBAL_VAR BOOLEAN           is_consistent /* !is_consistent <=> toutes les f_struct sont incoherentes */;
SX_GLOBAL_VAR BOOLEAN           with_ranking;
SX_GLOBAL_VAR BOOLEAN           relaxed_run_allowed, is_unique_parse, is_print_output_dag, is_ranking;
SX_GLOBAL_VAR BOOLEAN           is_print_final_f_structure_number, is_proba_ranking, is_nbest_ranking;
...
SX_GLOBAL_VAR BOOLEAN           set_fs_id_signature (int fs_id, int level, BOOLEAN (*f)());
...
SX_GLOBAL_VAR BOOLEAN           fs_is_set (int fs_id, int field_id, int **ret_val);
...
#ifdef ESSAI
SX_GLOBAL_VAR int               get_ufs_atom_val (int val, BOOLEAN *is_shared, SXBA local_atom_id_set); /* Pour output_semact !! */
