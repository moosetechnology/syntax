...
extern BOOLEAN			XxY_write (/* XxY_header *header_ptr;
					      int file; */);
/* Write on "file" the structure "*header_ptr" */

extern BOOLEAN			XxY_read (/* XxY_header *header_ptr;
					     int file; 
					     char *name;
					     int (*user_oflw) ();
					     FILE *stat_file; */);
...
extern void			XxY_to_c (/* XxY_header *header_ptr;
					     FILE *F_X;
					     char *name;
					     BOOLEAN is_static; */);
...
extern void			XxY_array_to_c (/* XxY_header *header_ptr;
						   FILE *F_X;
						   char *name; */);

/* Print on "F_X" the C text for the "arrays" of "header_ptr" */

extern void			XxY_header_to_c (/* XxY_header *header_ptr;
						    FILE *F_X;
						    char *name; */);

/* Print on "F_X" the C text for the "header" of "header_ptr" */

extern void			XxY_reuse (/* XxY_header *header_ptr;
					      char *name;
					      int (*user_oflw)();
					      FILE *stat_file; */);
