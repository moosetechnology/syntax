...
typedef struct {
    ...
    void		(*move) (/* sxSL_header *header, int old_indx,
				    int new_indx, int lgth */);

    int			(*oflw) (/* sxSL_header *header, int new_size */);
...
#define sxSL_7F	(((unsigned int) (~0))>>1)
#define sxSL_80	(~sxSL_7F)


/* (h,n,s,o,m) == (header, list_nb, average_list_size, int (*oflw)(header, new_size),
...
extern BOOLEAN			sxSL_GC (/* sxSL_header *header */);
