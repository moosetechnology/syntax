...
case ABBREVIATION_n :
	...
	case 1 :/* VISITED->name = {ABBREVIATION_PRDCT_NAME_n, ABBREVIATION_RE_NAME_n} */
	break;

	case 2 :/* VISITED->name = {PRDCT_EXPRESSION_n, REGULAR_EXPRESSION_n} */
	break;
...
case ABBREVIATION_S_n :/* VISITED->name = ABBREVIATION_n */
break;

case ALTERNATIVE_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = {ACTION_ERASE_n, ACTION_NO_n, ALTERNATIVE_n, DECR_n, ERASE_n, EXPRESSION_n, 
 ...
 */
	...
	case 2 :/* VISITED->name = {ACTION_ERASE_n, ACTION_NO_n, DECR_n, ERASE_n, EXPRESSION_n, EXTENDED_CLASS_REF_n, ID_n, 
...
case CLASS_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = CLASS_NAME_n */
	break;

	case 2 :/* VISITED->name = {ID_n, MINUS_n, OCTAL_CODE_n, PLUS_n, SLICE_n, STRING_n} */
	break;
...
case CLASS_S_n :/* VISITED->name = CLASS_n */
break;

case COLLATING_S_n :/* VISITED->name = {ID_n, INTEGER_NUMBER_n, NO_SPECIFIED_n, OCTAL_CODE_n, SLICE_n, STRING_n} */
break;

case COMPONENT_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = COMPONENT_DEF_n */
	break;

	case 2 :/* VISITED->name = {ENVIRONMENT_S_n, VOID_n} */
	break;
...
case COMPONENTS_S_n :/* VISITED->name = COMPONENT_n */
break;

case COMPONENT_DEF_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = COMPONENT_NAME_DEF_n */
	break;

	case 2 :/* VISITED->name = REGULAR_EXPRESSION_n */
	break;
...
case COMPONENT_REF_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = {CONTEXT_COMMENTS_n, CONTEXT_EOF_n, CONTEXT_INCLUDE_n, CONTEXT_NAME_n} */
	break;

	case 2 :/* VISITED->name = {COMPONENT_NAME_REF_n, VOID_n} */
	break;
...
case CONTEXT_n :/* VISITED->name = TOKEN_REF_S_n */
break;

case DENOTATION_S_n :/* VISITED->name = {ID_DENOTATION_n, STRING_DENOTATION_n} */
break;

case ENVIRONMENT_S_n :/* VISITED->name = {CONTEXT_n, KEYWORDS_SPEC_n, POST_ACTION_n, PRIORITY_KIND_S_n, RESTRICTED_CONTEXT_n, 
UNBOUNDED_CONTEXT_n, UNBOUNDED_RESTRICTED_CONTEXT_n} */
break;

case ERASE_n :/* VISITED->name = {ACTION_ERASE_n, ACTION_NO_n, DECR_n, EXPRESSION_n, EXTENDED_CLASS_REF_n, ID_n, INCR_n, 
...
case EXPRESSION_n :/* VISITED->name = {ACTION_ERASE_n, ACTION_NO_n, ALTERNATIVE_n, DECR_n, ERASE_n, EXPRESSION_n, 
...
case EXTENDED_CLASS_REF_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = {ID_n, NOT_n, OCTAL_CODE_n, SLICE_n, STRING_n} */
	break;

	case 2 :/* VISITED->name = {IS_FALSE_n, IS_FIRST_COL_n, IS_LAST_COL_n, IS_RESET_n, IS_SET_n, IS_TRUE_n, 
...
case MINUS_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = {ID_n, MINUS_n, OCTAL_CODE_n, PLUS_n, SLICE_n, STRING_n} */
	break;
...
case NOT_n :/* VISITED->name = {ID_n, OCTAL_CODE_n, SLICE_n, STRING_n} */
break;

case NOT_KEYWORDS_n :/* VISITED->name = KEYWORD_NAME_n */
break;

case OPTION_n :/* VISITED->name = {ACTION_ERASE_n, ACTION_NO_n, ALTERNATIVE_n, DECR_n, ERASE_n, EXPRESSION_n, 
EXTENDED_CLASS_REF_n, ID_n, INCR_n, LOWER_CASE_n, LOWER_TO_UPPER_n, MARK_n, NOT_n, OCTAL_CODE_n, OPTION_n, PUT_n, 
REF_TRANS_CLOSURE_n, RELEASE_n, RESET_n, SEQUENCE_n, SET_n, SLICE_n, STRING_n, TRANS_CLOSURE_n, UPPER_CASE_n, UPPER_TO_LOWER_n}
 */
break;
...
case PRDCT_ET_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = {EXPRESSION_n, IS_FIRST_COL_n, IS_LAST_COL_n, IS_RESET_n, IS_SET_n, PRDCT_ET_n, PRDCT_NOT_n
, PREDICATE_NAME_n, PREDICATE_NO_n} */
	break;

	case 2 :/* VISITED->name = {EXPRESSION_n, IS_FIRST_COL_n, IS_LAST_COL_n, IS_RESET_n, IS_SET_n, PRDCT_NOT_n, 
PREDICATE_NAME_n, PREDICATE_NO_n} */
	break;
...
case PRDCT_EXPRESSION_n :/* VISITED->name = {EXPRESSION_n, IS_FIRST_COL_n, IS_LAST_COL_n, IS_RESET_n, IS_SET_n, PRDCT_ET_n, 
PRDCT_NOT_n, PRDCT_OR_n, PREDICATE_NAME_n, PREDICATE_NO_n} */
break;

case PRDCT_NOT_n :/* VISITED->name = {IS_FIRST_COL_n, IS_LAST_COL_n, IS_RESET_n, IS_SET_n, PREDICATE_NO_n} */
break;
...
, PRDCT_OR_n, PREDICATE_NAME_n, PREDICATE_NO_n} */
	...
	case 2 :/* VISITED->name = {EXPRESSION_n, IS_FIRST_COL_n, IS_LAST_COL_n, IS_RESET_n, IS_SET_n, PRDCT_ET_n, PRDCT_NOT_n
, PREDICATE_NAME_n, PREDICATE_NO_n} */
	break;
...
case PRIORITY_KIND_S_n :/* VISITED->name = {REDUCE_REDUCE_n, REDUCE_SHIFT_n, SHIFT_REDUCE_n} */
break;

case PROGRAM_ROOT_LECL_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = {CLASS_S_n, VOID_n} */
	break;

	case 2 :/* VISITED->name = {ABBREVIATION_S_n, VOID_n} */
	break;

	case 3 :/* VISITED->name = {TOKEN_S_n, VOID_n} */
	break;

	case 4 :/* VISITED->name = {SYNONYM_S_n, VOID_n} */
	break;

	case 5 :/* VISITED->name = {REPR_SPEC_S_n, VOID_n} */
	break;
...
case PUT_n :/* VISITED->name = {ID_n, OCTAL_CODE_n, STRING_n} */
break;

case REF_TRANS_CLOSURE_n :/* VISITED->name = {ACTION_ERASE_n, ACTION_NO_n, ALTERNATIVE_n, DECR_n, ERASE_n, EXPRESSION_n, 
EXTENDED_CLASS_REF_n, ID_n, INCR_n, LOWER_CASE_n, LOWER_TO_UPPER_n, MARK_n, NOT_n, OCTAL_CODE_n, OPTION_n, PUT_n, 
REF_TRANS_CLOSURE_n, RELEASE_n, RESET_n, SEQUENCE_n, SET_n, SLICE_n, STRING_n, TRANS_CLOSURE_n, UPPER_CASE_n, UPPER_TO_LOWER_n}
 */
break;

case REGULAR_EXPRESSION_n :/* VISITED->name = {ACTION_ERASE_n, ACTION_NO_n, ALTERNATIVE_n, DECR_n, ERASE_n, EXPRESSION_n, 
EXTENDED_CLASS_REF_n, ID_n, INCR_n, LOWER_CASE_n, LOWER_TO_UPPER_n, MARK_n, NOT_n, OCTAL_CODE_n, OPTION_n, PUT_n, 
REF_TRANS_CLOSURE_n, RELEASE_n, RESET_n, SEQUENCE_n, SET_n, SLICE_n, STRING_n, TRANS_CLOSURE_n, UPPER_CASE_n, UPPER_TO_LOWER_n}
 */
break;

case REPR_SPEC_S_n :/* VISITED->name = {BYTE_LENGTH_n, COLLATING_S_n, WORD_LENGTH_n} */
break;

case RESTRICTED_CONTEXT_n :/* VISITED->name = {TOKEN_REF_S_n, VOID_n} */
break;

case SEQUENCE_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = {ACTION_ERASE_n, ACTION_NO_n, DECR_n, ERASE_n, EXPRESSION_n, EXTENDED_CLASS_REF_n, ID_n, 
INCR_n, LOWER_CASE_n, LOWER_TO_UPPER_n, MARK_n, NOT_n, OCTAL_CODE_n, OPTION_n, PUT_n, REF_TRANS_CLOSURE_n, RELEASE_n, RESET_n, 
SEQUENCE_n, SET_n, SLICE_n, STRING_n, TRANS_CLOSURE_n, UPPER_CASE_n, UPPER_TO_LOWER_n} */
	break;
...
case SLICE_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = {ID_n, OCTAL_CODE_n, STRING_n} */
	break;

	case 2 :/* VISITED->name = {ID_n, OCTAL_CODE_n, STRING_n} */
	break;
...
case SYNONYM_S_n :/* VISITED->name = DENOTATION_S_n */
break;

case TOKEN_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = TOKEN_DEF_n */
	break;
...
case TOKEN_DEF_n :
	switch (VISITED->position) {
	case 1 :/* VISITED->name = {COMMENTS_n, EOF_n, INCLUDE_n, LEXICAL_UNIT_NAME_n} */
	break;

	case 2 :/* VISITED->name = {COMPONENTS_S_n, REGULAR_EXPRESSION_n} */
	break;
...
case TOKEN_REF_S_n :/* VISITED->name = COMPONENT_REF_n */
break;

case TOKEN_S_n :/* VISITED->name = TOKEN_n */
break;

case TRANS_CLOSURE_n :/* VISITED->name = {ACTION_ERASE_n, ACTION_NO_n, ALTERNATIVE_n, DECR_n, ERASE_n, EXPRESSION_n, 
EXTENDED_CLASS_REF_n, ID_n, INCR_n, LOWER_CASE_n, LOWER_TO_UPPER_n, MARK_n, NOT_n, OCTAL_CODE_n, OPTION_n, PUT_n, 
REF_TRANS_CLOSURE_n, RELEASE_n, RESET_n, SEQUENCE_n, SET_n, SLICE_n, STRING_n, TRANS_CLOSURE_n, UPPER_CASE_n, UPPER_TO_LOWER_n}
 */
break;

case UNBOUNDED_CONTEXT_n :/* VISITED->name = TOKEN_REF_S_n */
break;

case UNBOUNDED_RESTRICTED_CONTEXT_n :/* VISITED->name = {TOKEN_REF_S_n, VOID_n} */
break;
