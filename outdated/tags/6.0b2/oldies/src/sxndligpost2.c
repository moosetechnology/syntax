    ...
    int	prdct_no, act_no, *kind;
{
    ...
    BOOLEAN		prdct_secondary, act_secondary, is_memo;
    ...
    int	prdct_no, act_no, kind;
{
    ...
    int		*pc, *pclim, *pprdct_bot, *pprdct_top;
    BOOLEAN	prdct_secondary, act_secondary;
    ...
    struct R	*Rkm1, *Rk;
{
    ...
    BOOLEAN	is_new = FALSE, is_right_foreach, is_left_foreach, is_left, is_right;
    SXBA	middle_set;
...
sxndlig_post2_do_it ()
{
    ...
    sxndlig.rule2attr = (struct rule2attr *) sxcalloc ((unsigned long int)parse_stack.rule_top + 1, sizeof (struct rule2attr));
...
*/
  ...
  case FINAL:
    sxndligpost (FINAL, 0); /* Pour un free... */
