...
#include "lecl_nn.h"
char WHAT_LECLTTS[] = "@(#)SYNTAX - $Id: lecl_tts.c 564 2007-05-15 15:19:42Z rlacroix $" WHAT_DEBUG;
...

static VOID	tree_to_string (visited)
...
VARSTR	lecl_tree_to_string (vs_ptr, visited, x, MARK)
    VARSTR	vs_ptr;
