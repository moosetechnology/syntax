...
#include "lecl_ag.h"
#include "S_tables.h"
char WHAT_LECLTOUT[] = "@(#)SYNTAX - $Id: lecl_tout.c 558 2007-05-15 11:01:17Z rlacroix $" WHAT_DEBUG;

/* */

extern BOOLEAN	lecl_write ();
extern VOID	lecl_free ();



VOID	lecl_tbls_out (lecl_tables_ptr)
    struct lecl_tables_s	*lecl_tables_ptr;
{
    register int	i, x;
    ...
    lecl_tables_ptr->S_char_to_simple_class = (unsigned char*) sxalloc ((int) (target_collate_length), sizeof (unsigned
	 char));
