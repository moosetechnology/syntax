...
#include "varstr.h"
#include "lecl_ag.h"
char WHAT_LECLSATURE[] = "@(#)SYNTAX - $Id: lecl_sature.c 606 2007-06-01 14:04:31Z rlacroix $" WHAT_DEBUG;



VOID	lecl_sature (nbt)
    int		nbt;
{
	...
	if (sxverbosep) {
	    ...
	    fprintf (sxtty, "Array %d of size %ld overflowed: reallocation with size %d.\n", nbt, old_size, lgt [nbt]);
	}
    }
