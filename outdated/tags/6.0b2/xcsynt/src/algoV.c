...
#include "sxunix.h"
#include "sxba.h"
char WHAT_XCSYNTALGOV[] = "@(#)SYNTAX - $Id: algoV.c 579 2007-05-24 11:30:48Z rlacroix $" WHAT_DEBUG;
...
static int	*new_to_old, *Vic, *sorted, *etats, used_nb;
...
static BOOLEAN	is_compatible (avector, aitem, lim)
...

VOID	algoV (is_nt, statemax, tmax, xrupt1, states, items, BASES, VECTOR, BASES_SET, m, M, DELTA, USED_NB)
    BOOLEAN	is_nt;
