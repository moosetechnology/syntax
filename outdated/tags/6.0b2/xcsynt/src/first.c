...
char WHAT_XCSYNTFIRST[] = "@(#)SYNTAX - $Id: first.c 579 2007-05-24 11:30:48Z rlacroix $" WHAT_DEBUG;
...
static BOOLEAN		(*parse_completed)();
...
static BOOLEAN prefixe (item, t_ref)
    int item, t_ref;
...
BOOLEAN earley_parse (LA_init, LA_final, hd, item, F)
