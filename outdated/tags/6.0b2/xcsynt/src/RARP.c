...
char WHAT_XCSYNTRARP[] = "@(#)SYNTAX - $Id: RARP.c 625 2007-06-12 08:35:56Z syntax $" WHAT_DEBUG;
...
static VOID open_UARP ()
{
	...
	if (ARP_states_set_size < l) {
	    ...
	    ARP_to_UARP = (int*) sxrealloc (ARP_to_UARP, l + 1, sizeof (int));
...
VOID build_UARP ()
{
    register int	ARP_state, next_ARP_state, x;
