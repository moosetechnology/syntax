...
#include "sxunix.h"
#include "sxdico.h"
char WHAT_DICOACT[] = "@(#)SYNTAX - $Id: dico_act.c 580 2007-05-24 12:45:54Z rlacroix $" WHAT_DEBUG;

extern int             optim_kind, process_kind, print_on_sxtty;
...
static int	word_list_set_size;

static void
mot2_oflw ()
{
    mot2.string = (char**) sxrealloc (mot2.string, (mot2.size *= 2) + 1, sizeof (char*));
    mot2.code = (int*) sxrealloc (mot2.code, mot2.size + 1, sizeof (int));
    mot2.lgth = (int*) sxrealloc (mot2.lgth, mot2.size + 1, sizeof (int));
}
