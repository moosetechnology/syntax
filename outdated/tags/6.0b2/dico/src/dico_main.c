...
#include "sxunix.h"
#include "sxdico.h"
char WHAT_DICOMAIN[] = "@(#)SYNTAX - $Id: dico_main.c 580 2007-05-24 12:45:54Z rlacroix $" WHAT_DEBUG;
...
int             optim_kind, process_kind, print_on_sxtty;
...
#define HELP 		        1
#define VERBOSE 		2
#define PARTIEL_opt             3
#define TOTAL_opt               4
#define TIME_opt                5
#define SPACE_opt               6
#define PREFIX_BOUND_opt        7
#define SUFFIX_BOUND_opt        8
#define DICO_NAME               9
#define STATIC_opt              10
#define EXTERN_opt              11
