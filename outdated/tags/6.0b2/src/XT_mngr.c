...
char WHAT_XT_MNGR[] = "@(#)SYNTAX - $Id: XT_mngr.c 527 2007-05-09 14:02:47Z rlacroix $" WHAT_DEBUG;



void
XT_alloc (header, name, init_elem_nb, average_list_nb_per_bucket,
	  average_list_size, oflw, stat_file)
    XT_header	*header;
    char	*name;
    ...
    XT_header	*header;
{
    ...
    fprintf (stat_file, "XT_header: Total_sizeof (byte) = %d (%d%%)\n", total_sizeof, (100*used_sizeof)/total_sizeof);
}
