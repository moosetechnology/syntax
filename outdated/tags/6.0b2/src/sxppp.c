...
char WHAT_SXPPP[] = "@(#)SYNTAX - $Id: sxppp.c 565 2007-05-23 10:05:12Z syntax $" WHAT_DEBUG;
...
static VOID	vider_sortie (continuer)
    BOOLEAN	continuer;
{
...
static VOID	vider_sortie_puis_1_car (c)
    char	c;
{
...
static VOID	ppabort (format, arg1, arg2, arg3)
    char	*format;
    char	*arg1, *arg2, *arg3;
{
    ...
    char	*ch_ptr;
{
    ...
    int		nb_NEW_LINEs, nb_NEW_LINEs_en_fin;
    int		sv_column;
...
decode_directive:
	...
	printf ("directive #%d of production %d:\t", saved_info.CO - sxppvariables.PP_tables [saved_info.noeud->name] + 1, saved_info.noeud->name);
    ...
    struct sxtables	*sxtables;
{
    ...
    sxppvariables.terminal_string_info = (struct string_info*) sxcalloc ((unsigned long int)(sxppvariables.tsi_top = 100) + sxppvariables.tmax, sizeof (struct string_info)) + sxppvariables.tmax;
...
VOID	sxppp (sxppp_what, sxtables)
    int		sxppp_what;
    struct sxtables	*sxtables;
{
    switch (sxppp_what) {
