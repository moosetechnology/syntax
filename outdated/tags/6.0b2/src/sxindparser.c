...
char WHAT_SXIND_PARSER[] = "@(#)SYNTAX - $Id: sxindparser.c 527 2007-05-09 14:02:47Z rlacroix $" WHAT_DEBUG;
    ...
    int			son, state, symbol;
{
    ...
    int					link, t_state, lim, red_no, son_state;
    ...
    struct sxtables	*arg;
{
	...
	parse_stack.parsers_rhs1 = (int*) sxalloc (parse_stack.graph_size + 1, sizeof (int));
	    ...
	    parse_stack.for_actor = (int*) sxcalloc (SIZE, sizeof (int));
