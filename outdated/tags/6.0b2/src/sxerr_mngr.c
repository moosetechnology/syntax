...
char WHAT_SXERR_MNGR[] = "@(#)SYNTAX - $Id: sxerr_mngr.c 527 2007-05-09 14:02:47Z rlacroix $" WHAT_DEBUG;
...
#define blanks_len	(sizeof (blanks) - 1) /* MUST be >= TAB_INTERVAL */
    static char		blanks [] = "               ";
    register int	char_count /* number of characters read */ ;
	...
	if ((unsigned int)(++char_count) == source_index.column) {
	    mark_pos = line_len;
	}
    ...
    char	*arg1, *arg2, *arg3, *arg4, *arg5, *arg6;
{
	...
	source_index.file_name = file_name;
	source_index.line = ~((unsigned long) 0);
	source_index.column = 0;
	fprintf (sxerrmngr.scratch_file, format, arg1, arg2, arg3, arg4, arg5, arg6);
	keep_message (source_index, severity);
    }
 ...
 */
	...
	register int	sxerrsort_index /* looks at each message in turn */ ;
...
VOID	sxerr_mngr (sxerr_mngr_what)
    int		sxerr_mngr_what;
{
