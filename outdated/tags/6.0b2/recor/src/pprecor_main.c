...
#include "sxunix.h"
char WHAT_PPRECOR_MAIN[] = "@(#)SYNTAX - $Id: pprecor_main.c 580 2007-05-24 12:45:54Z rlacroix $" WHAT_DEBUG;
...
static int	option_kind [] = {UNKNOWN_ARG, KWUC, KWUC, KWLC, KWLC, KWCI, KWCI, KWDK, KWDK, -KWDK, -KWDK, VERBOSE,
...
static	SXVOID pprecor_run (pathname)
