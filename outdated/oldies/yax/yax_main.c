...
#include <sys/types.h>
#include <sys/stat.h>
char WHAT_YAXMAIN[] = "@(#)SYNTAX - $Id: yax_main.c 4255 2024-09-06 08:32:39Z garavel $" WHAT_DEBUG;
...
extern SXSCANACT_FUNCTION dec_scanact;
extern SXSCANACT_FUNCTION def_scanact;
...
int main (int argc, char *argv[])
{
  ...
  sxset_scanner_action (dec_tables, dec_scanact);
  sxset_scanner_action (def_tables, def_scanact);
