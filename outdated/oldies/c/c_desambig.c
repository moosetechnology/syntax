...
static SXINT	current_block_level, new_block_level, *levels_stack, *id_stack;
...
static void identifiers_oflw (SXINT old_size, SXINT new_size)
{
    (void) old_size;
...
static void alloc_attributes (int size)
{
