...
extern SXINT read_a_udag (void (*store)(void) /* store_dag */,
			  void (*pre_fill)(void),
			  void (*fill)(void),
			  SXINT (*check)(void),
...
idag_source_processing (SXINT SXEOF, SXBA *t2suffix_t_set, SXBA *mlstn2suffix_source_set, SXBA *mlstn2la_tset, SXBA *t2la_t_set)
{
  ...
  SXBA   suffix_source_set, next_suffix_source_set, la_t_set, next_la_t_set;
#if 0
   SXBA next_lb_t_set;
#endif
...
fill_idag_infos (void)
{
  ...
  if (tables) {
    ...
    sxsvar.SXS_tables.S_check_keyword = dummy_check_keyword;
#endif /* def_sxdfa_comb_inflected_form */
  }
#endif /* is_LFG */
...
dag_scanner (SXINT what, SXTABLES *arg /* reçoit toujours NULL*/)
{
  ...
  case SXBEGIN :
    ...
    if (dag_kind == SDAG_KIND && tables)
      ...
      (*(tables->SX_parser)) (SXBEGIN, tables) /* Allocation des variables globales du parser */ ;
#endif /* 0 */
