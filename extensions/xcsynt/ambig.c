...
char WHAT_XCSYNTAMBIG[] = "@(#)SYNTAX - $Id: ambig.c 3652 2023-12-24 09:43:15Z garavel $" WHAT_DEBUG;
...
static char	dots [] = " ... ";
static char	equals [] = " === ";
static bool	grow_items1 (SXINT *incl, 
			     SXINT *path, 
...
static bool	grow_items2 (SXINT *incl, 
			     SXINT *path, 
...
bool is_t_trans_function (SXINT item)
{
...
bool is_t_in_first (SXINT t, SXINT item)
{
  /* item : A -> alpha . X1 --- Xn */
...
static bool	SCC (SXINT origine, SXINT X1, SXINT *stack, SXBA check_set)
{
...
static bool	includes_traversal (SXINT X)
{
...
static bool check_item (SXINT item, SXINT *check_item_S_stack, SXINT *check_item_NT_stack)
{
...
static bool	read_non_empty (SXINT read_non_empty_next_state)
{
    SXINT 	n, item, kind;
...
static bool	ambiguity_check (SXINT X1)
{
...
bool	ambiguity (SXBA conflict_set, SXBA ambig_root_set)
{
    ...
    SXINT	StNt, St;
    bool		ambiguity_is_ambiguous = false;
...
bool is_ambig_on_StNt (SXINT StNt)
{
...
static bool ambig_orig_F (SXINT X)
{
...
bool	is_not_nullable (SXINT xnt)
{
...
static bool cycle_set_to_path (SXINT X)
{
