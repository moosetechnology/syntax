...
char WHAT_XCSYNTXARC[] = "@(#)SYNTAX - $Id: XARC.c 3652 2023-12-24 09:43:15Z garavel $" WHAT_DEBUG;

extern void	print_bfsa (SXINT bfsa, SXINT ate);
extern void	print_pss (SXINT pss);
extern bool	PARTIAL_FSA_ARP_construction (struct ARC_struct *XARC, SXINT fsa1, SXINT bfsa2);
...
extern SXINT	UNBOUNDED_ARP_construction (struct ARC_struct *XARC,
					    SXINT	qtq,
					    bool message_needed);
extern bool	make_inter_pss (SXINT pss1, SXINT pss2);
extern char	*conflict_kind_to_string (VARSTR result, SXINT conflict_kind, SXINT h_val, SXINT k_val);
extern bool	bh_mark (struct ARC_struct *ARC, SXINT qtq);
extern bool	bh_unmark (struct ARC_struct *ARC, SXINT qtq);
...
static bool check_loop_on_back (SXINT X1)
{
...
static bool call_check_loop_on_back (void)
{
    SXINT ipss = 0;
...
static void	reached_states (SXBA reached_set, SXBA reached_states_couples_set, bool normal)
{
...
bool	XARC_state_scan (struct ARC_struct *XARC, 
			 SXINT qtq, 
			 bool (*F)(struct ARC_struct*, SXINT, SXINT, SXINT, SXINT, SXINT))
{
...
static bool	FSA_case (struct ARC_struct *XARC,
			  SXINT	qtq, 
...
static bool	fork_equality (struct ARC_struct *XARC,
			       SXINT qtq, 
...
void	XARC_print (struct ARC_struct *XARC)
{
    ...
    put_edit_nl (4);
    get_constructor_name (c_name, false, (bool) (XARC->pss_kind != UNBOUNDED_), XARC->h_value, XARC->k_value);
...
static bool	XARC_trans (struct ARC_struct *XARC,
			    SXINT XARC_state, 
			    SXINT t, 
