...
extern bool	is_t_trans_function (SXINT item);
...
struct ARC_ATTR {
    ...
    bool	is_tree_orig, is_pure_tree;
    char	is_marked;
};
struct whd {
    SXINT		lnk, type_nb;
...
SX_GLOBAL_VAR_XCSYNT bool		XX_is_XARC, XX_is_pss_check;
...
SX_GLOBAL_VAR_XCSYNT bool		is_shift_type, ibfsa_needed, has_several_equiv_reductions, is_clonable;
...
SX_GLOBAL_VAR_XCSYNT bool		conflict_message;
