...
char WHAT_XCSYNTSINGLE[] = "@(#)SYNTAX - $Id: single.c 3179 2023-05-06 08:32:16Z garavel $" WHAT_DEBUG;
...
static SXVOID	create_new_trans (struct nt_etat *aetat,
				  SXINT	A, 
				  SXINT prdct, 
				  SXINT action)
{
...
SXVOID	total_spe (SXBA total_spe_single_prod)
{
...
SXVOID	partial_spe (SXBA partial_spe_single_prod, SXBA restriction_set)
{
