...
char WHAT_XCSYNTXPRDCTMNGR[] = "@(#)SYNTAX - $Id: xprdct_mngr.c 3652 2023-12-24 09:43:15Z garavel $" WHAT_DEBUG;
...
bool		prdct_equal (SXINT xprdct, SXINT prdct1, SXINT prdct2)
{
...
void build_branch (SXINT xprdct, struct floyd_evans *fe, SXINT father)
{
