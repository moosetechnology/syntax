...
char WHAT_LFGLEXSCANACT[] = "@(#)SYNTAX - $Id: lfg_lex_scanact.c 4222 2024-09-03 08:02:15Z garavel $" WHAT_DEBUG;
...
bool sxscanner_action (SXINT entry, SXINT act_no)
{
  switch (entry) {
    ...
    default :
      fputs ("The function \"sxscanner_action\" for lfg/lfg_le is out of date w.r.t. its specification.\n", sxstderr);
      sxexit (3) /* panic */;
  }
}
